...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class CustomFieldSets : Base<CustomFieldSetsModel>
  {
    protected internal CustomFieldSets(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<CustomFieldSetsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public CustomFieldSetsModel Get(string orgCode, string @class, string code, Ungerboeck.Api.Models.Options.Subjects.CustomFieldSets options = null)
    {
      return base.Get(new { orgCode, @class, code }, options);
    }
  }
}
