...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class ExpenseReportApprovals : Base<ExpenseReportApprovalsModel>
  {
    protected internal ExpenseReportApprovals(ApiClient api) : base(api) { }
    ...
    public Ungerboeck.Api.Models.Search.SearchResponse<ExpenseReportApprovalsModel> Search(string searchOData, Search options = null)
    {
    ...
    public ExpenseReportApprovalsModel Get(int logSequence, Ungerboeck.Api.Models.Options.Subjects.ExpenseReportApprovals options = null)
    {
      return base.Get(new { logSequence }, options);
    }
  }
}
