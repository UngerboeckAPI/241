...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class SessionProposalEvaluations : Base<SessionProposalEvaluationsModel>
  {
    protected internal SessionProposalEvaluations(ApiClient api) : base(api) { }
    ...
    public Ungerboeck.Api.Models.Search.SearchResponse<SessionProposalEvaluationsModel> Search(string searchOData, Search options = null)
    {
    ...
    public SessionProposalEvaluationsModel Get(int sessionProposalEvaluationID, Ungerboeck.Api.Models.Options.Subjects.SessionProposalEvaluations options = null)
    {
      return base.Get(new { sessionProposalEvaluationID }, options);
    }
    ...
    public SessionProposalEvaluationsModel Update(SessionProposalEvaluationsModel model, Ungerboeck.Api.Models.Options.Subjects.SessionProposalEvaluations options = null)
    {
      return base.Update(new { model.SessionProposalEvaluationID }, model, options);
    }
    ...
    public SessionProposalEvaluationsModel Add(SessionProposalEvaluationsModel model, Ungerboeck.Api.Models.Options.Subjects.SessionProposalEvaluations options = null)
    {
    ...
    public HttpResponseMessage Delete(int sessionProposalEvaluationID, Ungerboeck.Api.Models.Options.Subjects.SessionProposalEvaluations options = null)
    {
      return base.Delete(new { sessionProposalEvaluationID }, options);
    }
  }
}
