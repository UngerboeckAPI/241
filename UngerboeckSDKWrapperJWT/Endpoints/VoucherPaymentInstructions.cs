...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class VoucherPaymentInstructions : Base<VoucherPaymentInstructionsModel>
  {
    protected internal VoucherPaymentInstructions(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<VoucherPaymentInstructionsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public VoucherPaymentInstructionsModel Get(string orgCode, int voucher, int sequenceNumber, Ungerboeck.Api.Models.Options.Subjects.VoucherPaymentInstructions options = null)
    {
      return base.Get(new { orgCode, voucher, sequenceNumber }, options);
    }
  }
}
