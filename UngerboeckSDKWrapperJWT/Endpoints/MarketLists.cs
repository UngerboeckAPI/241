...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class MarketLists : Base<MarketListsModel>
  {
    protected internal MarketLists(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<MarketListsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public MarketListsModel Get(string orgCode, string code, Ungerboeck.Api.Models.Options.Subjects.MarketLists options = null)
    {
