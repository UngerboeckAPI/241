...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class VoucherDistribution : Base<VoucherDistributionModel>
  {
    protected internal VoucherDistribution(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<VoucherDistributionModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public VoucherDistributionModel Get(string orgCode, int voucher, int sequence, Ungerboeck.Api.Models.Options.Subjects.VoucherDistribution options = null)
    {
      return base.Get(new { orgCode, voucher, sequence }, options);
    }
  }
}
