...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class EventJobClasses : Base<EventJobClassesModel>
  {
    protected internal EventJobClasses(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<EventJobClassesModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public EventJobClassesModel Get(string orgCode, string code, Ungerboeck.Api.Models.Options.Subjects.EventJobClasses options = null)
    {
