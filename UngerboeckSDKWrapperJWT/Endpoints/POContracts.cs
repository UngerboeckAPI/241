...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class POContracts : Base<POContractsModel>
  {
    protected internal POContracts(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<POContractsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public POContractsModel Get(string orgCode, int contractID, Ungerboeck.Api.Models.Options.Subjects.POContracts options = null)
    {
      return base.Get(new { orgCode, contractID }, options);
    }
  }
}
