...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class AccountMailingLists : Base<AccountMailingListsModel>
  {
    protected internal AccountMailingLists(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<AccountMailingListsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public AccountMailingListsModel Get(string orgCode, int iD, Ungerboeck.Api.Models.Options.Subjects.AccountMailingLists options = null)
    {
    ...
    public AccountMailingListsModel Update(AccountMailingListsModel model, Ungerboeck.Api.Models.Options.Subjects.AccountMailingLists options = null)
    {
    ...
    public AccountMailingListsModel Add(AccountMailingListsModel model, Ungerboeck.Api.Models.Options.Subjects.AccountMailingLists options = null)
    {
    ...
    public HttpResponseMessage Delete(string orgCode, int iD, Ungerboeck.Api.Models.Options.Subjects.AccountMailingLists options = null)
    {
