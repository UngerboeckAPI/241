...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class GLDeferralRevenueHeaders : Base<GLDeferralRevenueHeadersModel>
  {
    protected internal GLDeferralRevenueHeaders(ApiClient api) : base(api) { }
    ...
    public Ungerboeck.Api.Models.Search.SearchResponse<GLDeferralRevenueHeadersModel> Search(string searchOData, Search options = null)
    {
    ...
    public GLDeferralRevenueHeadersModel Get(int sequence, Ungerboeck.Api.Models.Options.Subjects.GLDeferralRevenueHeaders options = null)
    {
