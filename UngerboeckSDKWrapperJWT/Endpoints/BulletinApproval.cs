...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class BulletinApproval : Base<BulletinApprovalModel>
  {
    protected internal BulletinApproval(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<BulletinApprovalModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public BulletinApprovalModel Get(string orgCode, int meetingSequenceNumber, int bulletinSequenceNumber, int sequenceNumber, string bulletinFileID, Ungerboeck.Api.Models.Options.Subjects.BulletinApproval options = null)
    {
      return base.Get(new { orgCode, meetingSequenceNumber, bulletinSequenceNumber, sequenceNumber, bulletinFileID }, options);
    }
  }
}
