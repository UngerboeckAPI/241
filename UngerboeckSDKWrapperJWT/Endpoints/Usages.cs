...
{
  public class Usages : Base<UsagesModel>
  {
    protected internal Usages(ApiClient api) : base(api) { }
    ...
    public UsagesModel Get(string orgCode, string code, Ungerboeck.Api.Models.Options.Subjects.Usages options = null)
    {
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<UsagesModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public UsagesModel Update(UsagesModel model, Ungerboeck.Api.Models.Options.Subjects.Usages options = null)
    {
    ...
    public UsagesModel Add(UsagesModel model, Ungerboeck.Api.Models.Options.Subjects.Usages options = null)
    {
