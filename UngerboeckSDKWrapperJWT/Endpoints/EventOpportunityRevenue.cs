...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class EventOpportunityRevenue : Base<EventOpportunityRevenueModel>
  {
    protected internal EventOpportunityRevenue(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<EventOpportunityRevenueModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    /// </summary>
    /// <param name="id">Id of event opportunity revenue.</param>
    /// <param name="options">This contains optional configurations.</param>
    /// <returns>A single model for this subject.</returns>
    public EventOpportunityRevenueModel Get(int id, Ungerboeck.Api.Models.Options.Subjects.EventOpportunityRevenue options = null)
    {
    ...
    public EventOpportunityRevenueModel Update(EventOpportunityRevenueModel model, Ungerboeck.Api.Models.Options.Subjects.EventOpportunityRevenue options = null)
    {
    ...
    public EventOpportunityRevenueModel Add(EventOpportunityRevenueModel model, Ungerboeck.Api.Models.Options.Subjects.EventOpportunityRevenue options = null)
    {
