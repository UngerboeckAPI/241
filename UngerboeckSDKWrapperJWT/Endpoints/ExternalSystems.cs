...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class ExternalSystems : Base<ExternalSystemsModel>
  {
    protected internal ExternalSystems(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<ExternalSystemsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public ExternalSystemsModel Get(int id, Ungerboeck.Api.Models.Options.Subjects.ExternalSystems options = null)
    {
    ...
    public ExternalSystemsModel Update(ExternalSystemsModel model, Ungerboeck.Api.Models.Options.Subjects.ExternalSystems options = null)
    {
    ...
    public ExternalSystemsModel Add(ExternalSystemsModel model, Ungerboeck.Api.Models.Options.Subjects.ExternalSystems options = null)
    {
    ...
    public HttpResponseMessage Delete(int id, Ungerboeck.Api.Models.Options.Subjects.ExternalSystems options = null)
    {
