...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class AccountsReceivableVoucherAllocations : Base<AccountsReceivableVoucherAllocationsModel>
  {
    protected internal AccountsReceivableVoucherAllocations(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<AccountsReceivableVoucherAllocationsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public AccountsReceivableVoucherAllocationsModel Get(string orgCode, int voucherSequence, int voucherDetailSequence, Ungerboeck.Api.Models.Options.Subjects.AccountsReceivableVoucherAllocations options = null)
    {
      return base.Get(new { orgCode, voucherSequence, voucherDetailSequence }, options);
    }
  }
}
