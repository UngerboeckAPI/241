...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class PublicLanguages : Base<PublicLanguagesModel>
  {
    protected internal PublicLanguages(ApiClient api) : base(api) { }
    ...
    public Ungerboeck.Api.Models.Search.SearchResponse<PublicLanguagesModel> Search(string searchOData, Search options = null)
    {
    ...
    public PublicLanguagesModel Get(int sequence, Ungerboeck.Api.Models.Options.Subjects.PublicLanguages options = null)
    {
    ...
    public PublicLanguagesModel Update(PublicLanguagesModel model, Ungerboeck.Api.Models.Options.Subjects.PublicLanguages options = null)
    {
    ...
    public PublicLanguagesModel Add(PublicLanguagesModel model, Ungerboeck.Api.Models.Options.Subjects.PublicLanguages options = null)
    {
    ...
    public HttpResponseMessage Delete(int sequence, Ungerboeck.Api.Models.Options.Subjects.PublicLanguages options = null)
    {
