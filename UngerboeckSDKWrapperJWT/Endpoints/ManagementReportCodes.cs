...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class ManagementReportCodes : Base<ManagementReportCodesModel>
  {
    protected internal ManagementReportCodes(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<ManagementReportCodesModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public ManagementReportCodesModel Get(string orgCode, string code, Ungerboeck.Api.Models.Options.Subjects.ManagementReportCodes options = null)
    {
