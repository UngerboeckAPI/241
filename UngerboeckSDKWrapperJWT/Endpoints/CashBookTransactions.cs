...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class CashBookTransactions : Base<CashBookTransactionsModel>
  {
    protected internal CashBookTransactions(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<CashBookTransactionsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public CashBookTransactionsModel Get(string orgCode, int sequence, Ungerboeck.Api.Models.Options.Subjects.CashBookTransactions options = null)
    {
