...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class Communications : Base<CommunicationsModel>
  {
    protected internal Communications(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<CommunicationsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public CommunicationsModel Get(string orgCode, string accountCode, int sequenceNumber, Ungerboeck.Api.Models.Options.Subjects.Communications options = null)
    {
      return base.Get(new { orgCode, accountCode, sequenceNumber }, options);
    }
    ...
    public CommunicationsModel Update(CommunicationsModel model, Ungerboeck.Api.Models.Options.Subjects.Communications options = null)
    {
      return base.Update(new { model.OrganizationCode, model.AccountCode, model.SequenceNumber }, model, options);
    }
    ...
    public CommunicationsModel Add(CommunicationsModel model, Ungerboeck.Api.Models.Options.Subjects.Communications options = null)
    {
    ...
    public HttpResponseMessage Delete(string orgCode, string accountCode, int sequenceNumber, Ungerboeck.Api.Models.Options.Subjects.Communications options = null)
    {
