...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class Organizations : Base<OrganizationsModel>
  {
    protected internal Organizations(ApiClient api) : base(api) { }
    ...
    public Ungerboeck.Api.Models.Search.SearchResponse<OrganizationsModel> Search(string searchOData, Search options = null)
    {
    ...
    public OrganizationsModel Get(string orgCode, Ungerboeck.Api.Models.Options.Subjects.Organizations options = null)
    {
      return base.Get(new { orgCode }, options);
    }
  }
}
