...
{
  public class EventTaskUsers : Base<EventTaskUsersModel>
  {
    protected internal EventTaskUsers(ApiClient api) : base(api) { }
    ...
    public EventTaskUsersModel Get(int eventTaskUsersID, Ungerboeck.Api.Models.Options.Subjects.EventTaskUsers options = null)
    {
      return base.Get(new { eventTaskUsersID }, options);
    }
    ...
    public Ungerboeck.Api.Models.Search.SearchResponse<EventTaskUsersModel> Search(string searchOData, Search options = null)
    {
