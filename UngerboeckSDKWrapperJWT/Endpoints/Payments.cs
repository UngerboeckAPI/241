...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class Payments : Base<PaymentsModel>
  {
    protected internal Payments(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<PaymentsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public PaymentsModel Get(string orgCode, string accountCode, int sequence, Ungerboeck.Api.Models.Options.Subjects.Payments options = null)
    {
      return base.Get(new { orgCode, accountCode, sequence }, options);
    }
    ...
    public PaymentsModel Update(PaymentsModel model, Ungerboeck.Api.Models.Options.Subjects.Payments options = null)
    {
      return base.Update(new { model.Organization, model.Account, model.Sequence }, model, options);
    }
    ...
    public PaymentsModel Add(PaymentsModel model, Ungerboeck.Api.Models.Options.Subjects.Payments options = null)
    {
