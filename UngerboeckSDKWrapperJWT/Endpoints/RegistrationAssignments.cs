...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class RegistrationAssignments : Base<RegistrationAssignmentsModel>
  {
    protected internal RegistrationAssignments(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<RegistrationAssignmentsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public RegistrationAssignmentsModel Get(string orgCode, int sequenceNumber, Ungerboeck.Api.Models.Options.Subjects.RegistrationAssignments options = null)
    {
    ...
    public RegistrationAssignmentsModel Update(RegistrationAssignmentsModel model, Ungerboeck.Api.Models.Options.Subjects.RegistrationAssignments options = null)
    {
    ...
    public RegistrationAssignmentsModel Add(RegistrationAssignmentsModel model, Ungerboeck.Api.Models.Options.Subjects.RegistrationAssignments options = null)
    {
    ...
    public HttpResponseMessage Delete(string orgCode, int sequenceNumber, Ungerboeck.Api.Models.Options.Subjects.RegistrationAssignments options = null)
    {
