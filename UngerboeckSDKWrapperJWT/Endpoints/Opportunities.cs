...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class Opportunities : Base<OpportunitiesModel>
  {
    protected internal Opportunities(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<OpportunitiesModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public OpportunitiesModel Get(string orgCode, string accountCode, int occurrence, Ungerboeck.Api.Models.Options.Subjects.Opportunities options = null)
    {
      return base.Get(new { orgCode, accountCode, occurrence }, options);
    }
    ...
    public OpportunitiesModel Update(OpportunitiesModel model, Ungerboeck.Api.Models.Options.Subjects.Opportunities options = null)
    {
      return base.Update(new { model.Organization, model.Account, model.SequenceNumber }, model, options);
    }
    ...
    public OpportunitiesModel Add(OpportunitiesModel model, Ungerboeck.Api.Models.Options.Subjects.Opportunities options = null)
    {
    ...
    public HttpResponseMessage Delete(string orgCode, string accountCode, int occurrence, Ungerboeck.Api.Models.Options.Subjects.Opportunities options = null)
    {
      return base.Delete(new { orgCode, accountCode, occurrence }, options);
    }
  }
}
