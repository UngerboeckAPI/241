...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class APDemographics : Base<APDemographicsModel>
  {
    protected internal APDemographics(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<APDemographicsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public APDemographicsModel Get(string orgCode, string supplier, Ungerboeck.Api.Models.Options.Subjects.APDemographics options = null)
    {
      return base.Get(new { orgCode, supplier }, options);
    }
  }
}
