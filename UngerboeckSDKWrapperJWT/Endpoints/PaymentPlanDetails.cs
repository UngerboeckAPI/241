...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class PaymentPlanDetails : Base<PaymentPlanDetailsModel>
  {
    protected internal PaymentPlanDetails(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<PaymentPlanDetailsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public PaymentPlanDetailsModel Get(string orgCode, int payPlanID, int payNumber, int sequence, Ungerboeck.Api.Models.Options.Subjects.PaymentPlanDetails options = null)
    {
      return base.Get(new { orgCode, payPlanID, payNumber, sequence }, options);
    }
  }
}
