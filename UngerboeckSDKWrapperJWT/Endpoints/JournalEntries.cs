...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class JournalEntries : Base<JournalEntriesModel>
  {
    protected internal JournalEntries(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<JournalEntriesModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public JournalEntriesModel Get(string orgCode, int year, int period, string source, string entryNumber, Ungerboeck.Api.Models.Options.Subjects.JournalEntries options = null)
    {
      return base.Get(new { orgCode, year, period, source, entryNumber }, options);
    }
    ...
    public JournalEntriesModel Update(JournalEntriesModel model, Ungerboeck.Api.Models.Options.Subjects.JournalEntries options = null)
    {
      return base.Update(new { model.Organization, model.Year, model.Period, model.Source, model.EntryNumber }, model, options);
    }
    ...
    public JournalEntriesModel Add(JournalEntriesModel model, Ungerboeck.Api.Models.Options.Subjects.JournalEntries options = null)
    {
