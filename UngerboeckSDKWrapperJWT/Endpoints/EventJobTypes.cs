...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class EventJobTypes : Base<EventJobTypesModel>
  {
    protected internal EventJobTypes(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<EventJobTypesModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public EventJobTypesModel Get(string orgCode, string code, Ungerboeck.Api.Models.Options.Subjects.EventJobTypes options = null)
    {
