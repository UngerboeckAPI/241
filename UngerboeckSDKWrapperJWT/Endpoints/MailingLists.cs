...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class MailingLists : Base<MailingListsModel>
  {
    protected internal MailingLists(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<MailingListsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public MailingListsModel Get(string orgCode, int iD, Ungerboeck.Api.Models.Options.Subjects.MailingLists options = null)
    {
