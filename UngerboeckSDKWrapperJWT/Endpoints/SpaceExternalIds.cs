...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class SpaceExternalIds : Base<SpaceExternalIdsModel>
  {
    protected internal SpaceExternalIds(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<SpaceExternalIdsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public SpaceExternalIdsModel Get(int id, Ungerboeck.Api.Models.Options.Subjects.SpaceExternalIds options = null)
    {
    ...
    public SpaceExternalIdsModel Update(SpaceExternalIdsModel model, Ungerboeck.Api.Models.Options.Subjects.SpaceExternalIds options = null)
    {
    ...
    public SpaceExternalIdsModel Add(SpaceExternalIdsModel model, Ungerboeck.Api.Models.Options.Subjects.SpaceExternalIds options = null)
    {
    ...
    public HttpResponseMessage Delete(int id, Ungerboeck.Api.Models.Options.Subjects.SpaceExternalIds options = null)
    {
