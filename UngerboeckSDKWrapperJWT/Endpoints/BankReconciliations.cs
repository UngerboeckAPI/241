...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class BankReconciliations : Base<BankReconciliationsModel>
  {
    protected internal BankReconciliations(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<BankReconciliationsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public BankReconciliationsModel Get(string orgCode, int sequenceNumber, Ungerboeck.Api.Models.Options.Subjects.BankReconciliations options = null)
    {
