...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class AssetTransactions : Base<AssetTransactionsModel>
  {
    protected internal AssetTransactions(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<AssetTransactionsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public AssetTransactionsModel Get(string orgCode, string asset, string book, int sequence, Ungerboeck.Api.Models.Options.Subjects.AssetTransactions options = null)
    {
      return base.Get(new { orgCode, asset, book, sequence }, options);
    }
  }
}
