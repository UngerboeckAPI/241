...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class Checklists : Base<ChecklistsModel>
  {
    protected internal Checklists(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<ChecklistsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public ChecklistsModel Get(string orgCode, string code, Ungerboeck.Api.Models.Options.Subjects.Checklists options = null)
    {
    ...
    public ChecklistsModel Update(ChecklistsModel model, Ungerboeck.Api.Models.Options.Subjects.Checklists options = null)
    {
    ...
    public ChecklistsModel Add(ChecklistsModel model, Ungerboeck.Api.Models.Options.Subjects.Checklists options = null)
    {
