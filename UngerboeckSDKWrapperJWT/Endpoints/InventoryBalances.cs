...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class InventoryBalances : Base<InventoryBalancesModel>
  {
    protected internal InventoryBalances(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<InventoryBalancesModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public InventoryBalancesModel Get(string orgCode, string item, string lotSerialNumber, string location, int fiscalYear, int fiscalPeriod, Ungerboeck.Api.Models.Options.Subjects.InventoryBalances options = null)
    {
      return base.Get(new { orgCode, item, lotSerialNumber, location, fiscalYear, fiscalPeriod }, options);
    }
  }
}
