...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class PurchaseOrderApprovalLevels : Base<PurchaseOrderApprovalLevelsModel>
  {
    protected internal PurchaseOrderApprovalLevels(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<PurchaseOrderApprovalLevelsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public PurchaseOrderApprovalLevelsModel Get(string orgCode, string type, int approvalLevel, Ungerboeck.Api.Models.Options.Subjects.PurchaseOrderApprovalLevels options = null)
    {
      return base.Get(new { orgCode, type, approvalLevel }, options);
    }
  }
}
