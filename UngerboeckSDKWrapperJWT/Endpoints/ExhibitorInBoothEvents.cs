...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class ExhibitorInBoothEvents : Base<ExhibitorInBoothEventsModel>
  {
    protected internal ExhibitorInBoothEvents(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<ExhibitorInBoothEventsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public ExhibitorInBoothEventsModel Get(int id, Ungerboeck.Api.Models.Options.Subjects.ExhibitorInBoothEvents options = null)
    {
    ...
    public ExhibitorInBoothEventsModel Update(ExhibitorInBoothEventsModel model, Ungerboeck.Api.Models.Options.Subjects.ExhibitorInBoothEvents options = null)
    {
    ...
    public ExhibitorInBoothEventsModel Add(ExhibitorInBoothEventsModel model, Ungerboeck.Api.Models.Options.Subjects.ExhibitorInBoothEvents options = null)
    {
