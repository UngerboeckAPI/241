...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class MembershipEngagementTypes : Base<MembershipEngagementTypesModel>
  {
    protected internal MembershipEngagementTypes(ApiClient api) : base(api) { }
    ...
    public Ungerboeck.Api.Models.Search.SearchResponse<MembershipEngagementTypesModel> Search(string searchOData, Search options = null)
    {
    ...
    public MembershipEngagementTypesModel Get(int engagementTypeId, Ungerboeck.Api.Models.Options.Subjects.MembershipEngagementTypes options = null)
    {
      return base.Get(new { engagementTypeId }, options);
    }
    ...
    public MembershipEngagementTypesModel Update(MembershipEngagementTypesModel model, Ungerboeck.Api.Models.Options.Subjects.MembershipEngagementTypes options = null)
    {
      return base.Update(new { model.EngagementTypeId }, model, options);
    }
    ...
    public MembershipEngagementTypesModel Add(MembershipEngagementTypesModel model, Ungerboeck.Api.Models.Options.Subjects.MembershipEngagementTypes options = null)
    {
    ...
    public HttpResponseMessage Delete(int engagementTypeId, Ungerboeck.Api.Models.Options.Subjects.MembershipEngagementTypes options = null)
    {
      return base.Delete(new { engagementTypeId }, options);
    }
  }
}
