...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class EventOpportunitySpaceRequirements : Base<EventOpportunitySpaceRequirementsModel>
  {
    protected internal EventOpportunitySpaceRequirements(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<EventOpportunitySpaceRequirementsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public EventOpportunitySpaceRequirementsModel Get(int id, Ungerboeck.Api.Models.Options.Subjects.EventOpportunitySpaceRequirements options = null)
    {
    ...
    public EventOpportunitySpaceRequirementsModel Update(EventOpportunitySpaceRequirementsModel model, Ungerboeck.Api.Models.Options.Subjects.EventOpportunitySpaceRequirements options = null)
    {
    ...
    public EventOpportunitySpaceRequirementsModel Add(EventOpportunitySpaceRequirementsModel model, Ungerboeck.Api.Models.Options.Subjects.EventOpportunitySpaceRequirements options = null)
    {
