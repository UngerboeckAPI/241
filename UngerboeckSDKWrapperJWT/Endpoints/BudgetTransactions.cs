...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class BudgetTransactions : Base<BudgetTransactionsModel>
  {
    protected internal BudgetTransactions(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<BudgetTransactionsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public BudgetTransactionsModel Get(string orgCode, string batch, int transactionNum, Ungerboeck.Api.Models.Options.Subjects.BudgetTransactions options = null)
    {
      return base.Get(new { orgCode, batch, transactionNum }, options);
    }
  }
}
