...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class EventOpportunityExternalIds : Base<EventOpportunityExternalIdsModel>
  {
    protected internal EventOpportunityExternalIds(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<EventOpportunityExternalIdsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public EventOpportunityExternalIdsModel Get(int id, Ungerboeck.Api.Models.Options.Subjects.EventOpportunityExternalIds options = null)
    {
    ...
    public EventOpportunityExternalIdsModel Update(EventOpportunityExternalIdsModel model, Ungerboeck.Api.Models.Options.Subjects.EventOpportunityExternalIds options = null)
    {
    ...
    public EventOpportunityExternalIdsModel Add(EventOpportunityExternalIdsModel model, Ungerboeck.Api.Models.Options.Subjects.EventOpportunityExternalIds options = null)
    {
    ...
    public HttpResponseMessage Delete(int id, Ungerboeck.Api.Models.Options.Subjects.EventOpportunityExternalIds options = null)
    {
