...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class Booths : Base<BoothsModel>
  {
    protected internal Booths(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<BoothsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public BoothsModel Get(string orgCode, int sequenceNumber, Ungerboeck.Api.Models.Options.Subjects.Booths options = null)
    {
    ...
    public BoothsModel Update(BoothsModel model, Ungerboeck.Api.Models.Options.Subjects.Booths options = null)
    {
    ...
    public BoothsModel Add(BoothsModel model, Ungerboeck.Api.Models.Options.Subjects.Booths options = null)
    {
    ...
    public HttpResponseMessage Delete(string orgCode, int sequenceNumber, Ungerboeck.Api.Models.Options.Subjects.Booths options = null)
    {
