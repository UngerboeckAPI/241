...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class StatementDetails : Base<StatementDetailsModel>
  {
    protected internal StatementDetails(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<StatementDetailsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public StatementDetailsModel Get(string orgCode, int batchSequence, int headerSequence, int sequenceNumber, Ungerboeck.Api.Models.Options.Subjects.StatementDetails options = null)
    {
      return base.Get(new { orgCode, batchSequence, headerSequence, sequenceNumber }, options);
    }
  }
}
