...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class GroupProfiles : Base<GroupProfilesModel>
  {
    protected internal GroupProfiles(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<GroupProfilesModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public GroupProfilesModel Get(string orgCode, int iD, Ungerboeck.Api.Models.Options.Subjects.GroupProfiles options = null)
    {
    ...
    public GroupProfilesModel Update(GroupProfilesModel model, Ungerboeck.Api.Models.Options.Subjects.GroupProfiles options = null)
    {
    ...
    public GroupProfilesModel Add(GroupProfilesModel model, Ungerboeck.Api.Models.Options.Subjects.GroupProfiles options = null)
    {
    ...
    public HttpResponseMessage Delete(string orgCode, int iD, Ungerboeck.Api.Models.Options.Subjects.GroupProfiles options = null)
    {
