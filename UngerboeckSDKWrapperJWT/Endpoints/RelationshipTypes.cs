...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class RelationshipTypes : Base<RelationshipTypesModel>
  {
    protected internal RelationshipTypes(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<RelationshipTypesModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public RelationshipTypesModel Get(string orgCode, string code, Ungerboeck.Api.Models.Options.Subjects.RelationshipTypes options = null)
    {
