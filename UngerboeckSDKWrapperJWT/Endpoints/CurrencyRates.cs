...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class CurrencyRates : Base<CurrencyRatesModel>
  {
    protected internal CurrencyRates(ApiClient api) : base(api) { }
    ...
    public Ungerboeck.Api.Models.Search.SearchResponse<CurrencyRatesModel> Search(string searchOData, Search options = null)
    {
    ...
    public CurrencyRatesModel Get(string currencyCode, int sequenceNumber, Ungerboeck.Api.Models.Options.Subjects.CurrencyRates options = null)
    {
      return base.Get(new { currencyCode, sequenceNumber }, options);
    }
    ...
    public CurrencyRatesModel Update(CurrencyRatesModel model, Ungerboeck.Api.Models.Options.Subjects.CurrencyRates options = null)
    {
      return base.Update(new { model.CurrencyCode, model.SequenceNumber }, model, options);
    }
    ...
    public CurrencyRatesModel Add(CurrencyRatesModel model, Ungerboeck.Api.Models.Options.Subjects.CurrencyRates options = null)
    {
