...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class OpportunityStatuses : Base<OpportunityStatusesModel>
  {
    protected internal OpportunityStatuses(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<OpportunityStatusesModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public OpportunityStatusesModel Get(string orgCode, string code, string designation, Ungerboeck.Api.Models.Options.Subjects.OpportunityStatuses options = null)
    {
      return base.Get(new { orgCode, code, designation }, options);
    }
  }
}
