...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class OrganizationParameters : Base<OrganizationParametersModel>
  {
    protected internal OrganizationParameters(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<OrganizationParametersModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public OrganizationParametersModel Get(string orgCode, string applicationCode, string parameterCode, Ungerboeck.Api.Models.Options.Subjects.OrganizationParameters options = null)
    {
      return base.Get(new { orgCode, applicationCode, parameterCode }, options);
    }
  }
}
