...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class VoucherTaxes : Base<VoucherTaxesModel>
  {
    protected internal VoucherTaxes(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<VoucherTaxesModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public VoucherTaxesModel Get(string orgCode, int voucher, int sequence, Ungerboeck.Api.Models.Options.Subjects.VoucherTaxes options = null)
    {
