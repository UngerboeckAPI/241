...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class PurchaseOrderDistributions : Base<PurchaseOrderDistributionsModel>
  {
    protected internal PurchaseOrderDistributions(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<PurchaseOrderDistributionsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public PurchaseOrderDistributionsModel Get(string orgCode, int number, int sequence, int line, Ungerboeck.Api.Models.Options.Subjects.PurchaseOrderDistributions options = null)
    {
      return base.Get(new { orgCode, number, sequence, line }, options);
    }
  }
}
