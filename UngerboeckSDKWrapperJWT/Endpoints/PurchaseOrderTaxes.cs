...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class PurchaseOrderTaxes : Base<PurchaseOrderTaxesModel>
  {
    protected internal PurchaseOrderTaxes(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<PurchaseOrderTaxesModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public PurchaseOrderTaxesModel Get(string orgCode, int number, int itemSequence, int sequence, Ungerboeck.Api.Models.Options.Subjects.PurchaseOrderTaxes options = null)
    {
