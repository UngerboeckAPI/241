...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class GLDistributions : Base<GLDistributionsModel>
  {
    protected internal GLDistributions(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<GLDistributionsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public GLDistributionsModel Get(string orgCode, string recordType, int sequenceNumber, Ungerboeck.Api.Models.Options.Subjects.GLDistributions options = null)
    {
      return base.Get(new { orgCode, recordType, sequenceNumber }, options);
    }
  }
}
