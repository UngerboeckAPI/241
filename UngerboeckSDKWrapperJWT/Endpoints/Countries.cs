...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class Countries : Base<CountriesModel>
  {
    protected internal Countries(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<CountriesModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public CountriesModel Get(string orgCode, string code, Ungerboeck.Api.Models.Options.Subjects.Countries options = null)
    {
      if (code == "***")
      {
        ...
        var task = base.GetAsync<CountriesModel>(Client, $"Countries/{orgCode}?code=***&", options); //Note the & at the end allows for other query parameters like 'Select'
