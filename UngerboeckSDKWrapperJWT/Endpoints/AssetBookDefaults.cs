...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class AssetBookDefaults : Base<AssetBookDefaultsModel>
  {
    protected internal AssetBookDefaults(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<AssetBookDefaultsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public AssetBookDefaultsModel Get(string orgCode, int sequenceNumber, Ungerboeck.Api.Models.Options.Subjects.AssetBookDefaults options = null)
    {
