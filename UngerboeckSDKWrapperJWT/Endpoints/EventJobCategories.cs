...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class EventJobCategories : Base<EventJobCategoriesModel>
  {
    protected internal EventJobCategories(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<EventJobCategoriesModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public EventJobCategoriesModel Get(string orgCode, string code, Ungerboeck.Api.Models.Options.Subjects.EventJobCategories options = null)
    {
