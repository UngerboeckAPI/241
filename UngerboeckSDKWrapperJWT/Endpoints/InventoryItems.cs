...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class InventoryItems : Base<InventoryItemsModel>
  {
    protected internal InventoryItems(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<InventoryItemsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public InventoryItemsModel Get(string orgCode, string code, Ungerboeck.Api.Models.Options.Subjects.InventoryItems options = null)
    {
    ...
    public InventoryItemsModel Update(InventoryItemsModel model, Ungerboeck.Api.Models.Options.Subjects.InventoryItems options = null)
    {
      return base.Update(new { model.Organization, model.Code }, model, options);
    }
    ...
    public InventoryItemsModel Add(InventoryItemsModel model, Ungerboeck.Api.Models.Options.Subjects.InventoryItems options = null)
    {
    ...
    public HttpResponseMessage Delete(string orgCode, string code, Ungerboeck.Api.Models.Options.Subjects.InventoryItems options = null)
    {
