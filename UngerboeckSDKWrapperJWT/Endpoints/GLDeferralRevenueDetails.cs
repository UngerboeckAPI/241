...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class GLDeferralRevenueDetails : Base<GLDeferralRevenueDetailsModel>
  {
    protected internal GLDeferralRevenueDetails(ApiClient api) : base(api) { }
    ...
    public Ungerboeck.Api.Models.Search.SearchResponse<GLDeferralRevenueDetailsModel> Search(string searchOData, Search options = null)
    {
    ...
    public GLDeferralRevenueDetailsModel Get(int hdrSequence, int sequence, Ungerboeck.Api.Models.Options.Subjects.GLDeferralRevenueDetails options = null)
    {
      return base.Get(new { hdrSequence, sequence }, options);
    }
  }
}
