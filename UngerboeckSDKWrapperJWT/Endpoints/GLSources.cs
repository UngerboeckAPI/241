...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class GLSources : Base<GLSourcesModel>
  {
    protected internal GLSources(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<GLSourcesModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public GLSourcesModel Get(string orgCode, string source, Ungerboeck.Api.Models.Options.Subjects.GLSources options = null)
    {
      return base.Get(new { orgCode, source }, options);
    }
  }
}
