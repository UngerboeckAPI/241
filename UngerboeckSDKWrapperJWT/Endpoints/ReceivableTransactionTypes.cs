...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class ReceivableTransactionTypes : Base<ReceivableTransactionTypesModel>
  {
    protected internal ReceivableTransactionTypes(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<ReceivableTransactionTypesModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public ReceivableTransactionTypesModel Get(string orgCode, string tSM, Ungerboeck.Api.Models.Options.Subjects.ReceivableTransactionTypes options = null)
    {
      return base.Get(new { orgCode, tSM }, options);
    }
  }
}
