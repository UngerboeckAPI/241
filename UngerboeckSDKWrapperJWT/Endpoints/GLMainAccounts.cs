...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class GLMainAccounts : Base<GLMainAccountsModel>
  {
    protected internal GLMainAccounts(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<GLMainAccountsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public GLMainAccountsModel Get(string orgCode, string gLMainAccount, Ungerboeck.Api.Models.Options.Subjects.GLMainAccounts options = null)
    {
      return base.Get(new { orgCode, gLMainAccount }, options);
    }
  }
}
