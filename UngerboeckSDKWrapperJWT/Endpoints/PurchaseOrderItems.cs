...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class PurchaseOrderItems : Base<PurchaseOrderItemsModel>
  {
    protected internal PurchaseOrderItems(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<PurchaseOrderItemsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public PurchaseOrderItemsModel Get(string orgCode, int number, int itemSequence, Ungerboeck.Api.Models.Options.Subjects.PurchaseOrderItems options = null)
    {
      return base.Get(new { orgCode, number, itemSequence }, options);
    }
    ...
    public PurchaseOrderItemsModel Update(PurchaseOrderItemsModel model, Ungerboeck.Api.Models.Options.Subjects.PurchaseOrderItems options = null)
    {
      return base.Update(new { model.Organization, model.Number, model.ItemSequence }, model, options);
    }
    ...
    public PurchaseOrderItemsModel Add(PurchaseOrderItemsModel model, Ungerboeck.Api.Models.Options.Subjects.PurchaseOrderItems options = null)
    {
