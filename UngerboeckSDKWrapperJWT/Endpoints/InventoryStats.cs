...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class InventoryStats : Base<InventoryStatsModel>
  {
    protected internal InventoryStats(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<InventoryStatsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public InventoryStatsModel Get(string orgCode, string item, string space, string lotSerialNumber, Ungerboeck.Api.Models.Options.Subjects.InventoryStats options = null)
    {
      return base.Get(new { orgCode, item, space, lotSerialNumber }, options);
    }
  }
}
