...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class Roles : Base<RolesModel>
  {
    protected internal Roles(ApiClient api) : base(api) { }
    ...
    public Ungerboeck.Api.Models.Search.SearchResponse<RolesModel> Search(string searchOData, Search options = null)
    {
    ...
    public RolesModel Get(string iD, Ungerboeck.Api.Models.Options.Subjects.Roles options = null)
    {
    ...
    public RolesModel Update(RolesModel model, Ungerboeck.Api.Models.Options.Subjects.Roles options = null)
    {
    ...
    public RolesModel Add(RolesModel model, Ungerboeck.Api.Models.Options.Subjects.Roles options = null)
    {
