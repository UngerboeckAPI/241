...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class CustomerTerms : Base<CustomerTermsModel>
  {
    protected internal CustomerTerms(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<CustomerTermsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public CustomerTermsModel Get(string orgCode, string code, Ungerboeck.Api.Models.Options.Subjects.CustomerTerms options = null)
    {
