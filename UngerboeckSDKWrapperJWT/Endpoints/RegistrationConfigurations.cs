...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class RegistrationConfigurations : Base<RegistrationConfigurationsModel>
  {
    protected internal RegistrationConfigurations(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<RegistrationConfigurationsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public RegistrationConfigurationsModel Get(string orgCode, string configurationCode, Ungerboeck.Api.Models.Options.Subjects.RegistrationConfigurations options = null)
    {
      return base.Get(new { orgCode, configurationCode }, options);
    }
    ...
    public RegistrationConfigurationsModel Update(RegistrationConfigurationsModel model, Ungerboeck.Api.Models.Options.Subjects.RegistrationConfigurations options = null)
    {
      return base.Update(new { model.OrganizationCode, model.ConfigurationCode }, model, options);
    }
    ...
    public RegistrationConfigurationsModel Add(RegistrationConfigurationsModel model, Ungerboeck.Api.Models.Options.Subjects.RegistrationConfigurations options = null)
    {
    ...
    public HttpResponseMessage Delete(string orgCode, string configurationCode, Ungerboeck.Api.Models.Options.Subjects.RegistrationConfigurations options = null)
    {
      return base.Delete(new { orgCode, configurationCode }, options);
    }
  }
}
