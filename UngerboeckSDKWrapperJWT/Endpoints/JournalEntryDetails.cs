...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class JournalEntryDetails : Base<JournalEntryDetailsModel>
  {
    protected internal JournalEntryDetails(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<JournalEntryDetailsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public JournalEntryDetailsModel Get(string orgCode, int year, int period, string source, string entryNumber, int line, Ungerboeck.Api.Models.Options.Subjects.JournalEntryDetails options = null)
    {
      return base.Get(new { orgCode, year, period, source, entryNumber, line }, options);
    }
    ...
    public JournalEntryDetailsModel Update(JournalEntryDetailsModel model, Ungerboeck.Api.Models.Options.Subjects.JournalEntryDetails options = null)
    {
      return base.Update(new { model.Organization, model.Year, model.Period, model.Source, model.EntryNumber, model.Line }, model, options);
    }
    ...
    public JournalEntryDetailsModel Add(JournalEntryDetailsModel model, Ungerboeck.Api.Models.Options.Subjects.JournalEntryDetails options = null)
    {
