...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class Meetings : Base<MeetingsModel>
  {
    protected internal Meetings(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<MeetingsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public MeetingsModel Get(string orgCode, int meetingSequence, Ungerboeck.Api.Models.Options.Subjects.Meetings options = null)
    {
    ...
    public MeetingsModel Update(MeetingsModel model, Ungerboeck.Api.Models.Options.Subjects.Meetings options = null)
    {
    ...
    public MeetingsModel Add(MeetingsModel model, Ungerboeck.Api.Models.Options.Subjects.Meetings options = null)
    {
