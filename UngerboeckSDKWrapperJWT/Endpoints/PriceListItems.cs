...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class PriceListItems : Base<PriceListItemsModel>
  {
    protected internal PriceListItems(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<PriceListItemsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public PriceListItemsModel Get(string orgCode, string priceList, int sequence, Ungerboeck.Api.Models.Options.Subjects.PriceListItems options = null)
    {
      return base.Get(new { orgCode, priceList, sequence }, options);
    }
    ...
    public PriceListItemsModel Update(PriceListItemsModel model, Ungerboeck.Api.Models.Options.Subjects.PriceListItems options = null)
    {
      return base.Update(new { model.OrganizationCode, model.PriceList, model.Sequence }, model, options);
    }
    ...
    public PriceListItemsModel Add(PriceListItemsModel model, Ungerboeck.Api.Models.Options.Subjects.PriceListItems options = null)
    {
    ...
    public HttpResponseMessage Delete(string orgCode, string priceList, int sequence, Ungerboeck.Api.Models.Options.Subjects.PriceListItems options = null)
    {
      return base.Delete(new { orgCode, priceList, sequence }, options);
    }
  }
}
