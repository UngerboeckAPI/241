...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class CustomFieldValidationTables : Base<CustomFieldValidationTablesModel>
  {
    protected internal CustomFieldValidationTables(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<CustomFieldValidationTablesModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public CustomFieldValidationTablesModel Get(string orgCode, int ID, Ungerboeck.Api.Models.Options.Subjects.CustomFieldValidationTables options = null)
    {
    ...
    public CustomFieldValidationTablesModel Update(CustomFieldValidationTablesModel model, Ungerboeck.Api.Models.Options.Subjects.CustomFieldValidationTables options = null)
    {
    ...
    public CustomFieldValidationTablesModel Add(CustomFieldValidationTablesModel model, Ungerboeck.Api.Models.Options.Subjects.CustomFieldValidationTables options = null)
    {
