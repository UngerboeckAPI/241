...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class MembershipEngagements : Base<MembershipEngagementsModel>
  {
    protected internal MembershipEngagements(ApiClient api) : base(api) { }
    ...
    public Ungerboeck.Api.Models.Search.SearchResponse<MembershipEngagementsModel> Search(string searchOData, Search options = null)
    {
    ...
    public MembershipEngagementsModel Get(int engagementId, Ungerboeck.Api.Models.Options.Subjects.MembershipEngagements options = null)
    {
      return base.Get(new { engagementId }, options);
    }
    ...
    public MembershipEngagementsModel Update(MembershipEngagementsModel model, Ungerboeck.Api.Models.Options.Subjects.MembershipEngagements options = null)
    {
      return base.Update(new { model.EngagementId }, model, options);
    }
    ...
    public MembershipEngagementsModel Add(MembershipEngagementsModel model, Ungerboeck.Api.Models.Options.Subjects.MembershipEngagements options = null)
    {
    ...
    public HttpResponseMessage Delete(int engagementId, Ungerboeck.Api.Models.Options.Subjects.MembershipEngagements options = null)
    {
      return base.Delete(new { engagementId }, options);
    }
  }
}
