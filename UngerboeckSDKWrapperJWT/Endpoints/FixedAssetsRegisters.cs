...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class FixedAssetsRegisters : Base<FixedAssetsRegistersModel>
  {
    protected internal FixedAssetsRegisters(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<FixedAssetsRegistersModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public FixedAssetsRegistersModel Get(string orgCode, string code, Ungerboeck.Api.Models.Options.Subjects.FixedAssetsRegisters options = null)
    {
