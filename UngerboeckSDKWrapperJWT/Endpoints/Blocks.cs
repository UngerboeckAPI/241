...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class Blocks : Base<BlocksModel>
  {
    protected internal Blocks(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<BlocksModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public BlocksModel Get(string orgCode, int eventID, string code, Ungerboeck.Api.Models.Options.Subjects.Blocks options = null)
    {
      return base.Get(new { orgCode, eventID, code }, options);
    }
  }
}
