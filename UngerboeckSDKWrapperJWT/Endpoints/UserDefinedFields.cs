...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class UserDefinedFields : Base<UserDefinedFieldsModel>
  {
    protected internal UserDefinedFields(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<UserDefinedFieldsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public UserDefinedFieldsModel Get(string orgCode, string issueOpportunityClass, string issueOpportunityType, int sequenceNumber, Ungerboeck.Api.Models.Options.Subjects.UserDefinedFields options = null)
    {
      return base.Get(new { orgCode, issueOpportunityClass, issueOpportunityType, sequenceNumber }, options);
    }
  }
}
