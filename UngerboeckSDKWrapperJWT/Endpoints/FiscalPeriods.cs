...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class FiscalPeriods : Base<FiscalPeriodsModel>
  {
    protected internal FiscalPeriods(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<FiscalPeriodsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public FiscalPeriodsModel Get(string orgCode, string module, int year, int period, Ungerboeck.Api.Models.Options.Subjects.FiscalPeriods options = null)
    {
      return base.Get(new { orgCode, module, year, period }, options);
    }
  }
}
