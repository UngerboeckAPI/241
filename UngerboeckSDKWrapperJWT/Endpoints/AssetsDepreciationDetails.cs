...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class AssetsDepreciationDetails : Base<AssetsDepreciationDetailsModel>
  {
    protected internal AssetsDepreciationDetails(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<AssetsDepreciationDetailsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public AssetsDepreciationDetailsModel Get(string orgCode, int sequence, string asset, int revision, string book, Ungerboeck.Api.Models.Options.Subjects.AssetsDepreciationDetails options = null)
    {
      return base.Get(new { orgCode, sequence, asset, revision, book }, options);
    }
  }
}
