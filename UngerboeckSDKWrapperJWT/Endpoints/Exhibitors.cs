...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class Exhibitors : Base<ExhibitorsModel>
  {
    protected internal Exhibitors(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<ExhibitorsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public ExhibitorsModel Get(string orgCode, int exhibitorID, Ungerboeck.Api.Models.Options.Subjects.Exhibitors options = null)
    {
      return base.Get(new { orgCode, exhibitorID }, options);
    }
    ...
    public ExhibitorsModel Update(ExhibitorsModel model, Ungerboeck.Api.Models.Options.Subjects.Exhibitors options = null)
    {
      return base.Update(new { model.OrganizationCode, model.ExhibitorID }, model, options);
    }
    ...
    public ExhibitorsModel Add(ExhibitorsModel model, Ungerboeck.Api.Models.Options.Subjects.Exhibitors options = null)
    {
