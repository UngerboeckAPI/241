...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class EventOpportunitySpaceRequirementsProposedSpaces : Base<EventOpportunitySpaceRequirementsProposedSpacesModel>
  {
    protected internal EventOpportunitySpaceRequirementsProposedSpaces(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<EventOpportunitySpaceRequirementsProposedSpacesModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public EventOpportunitySpaceRequirementsProposedSpacesModel Get(int id, Ungerboeck.Api.Models.Options.Subjects.EventOpportunitySpaceRequirementsProposedSpaces options = null)
    {
    ...
    public EventOpportunitySpaceRequirementsProposedSpacesModel Add(EventOpportunitySpaceRequirementsProposedSpacesModel model, Ungerboeck.Api.Models.Options.Subjects.EventOpportunitySpaceRequirementsProposedSpaces options = null)
    {
    ...
    public HttpResponseMessage Delete(int id, Ungerboeck.Api.Models.Options.Subjects.EventOpportunitySpaceRequirementsProposedSpaces options = null)
    {
