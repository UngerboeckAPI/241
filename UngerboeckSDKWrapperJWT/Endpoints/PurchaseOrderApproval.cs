...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class PurchaseOrderApproval : Base<PurchaseOrderApprovalModel>
  {
    protected internal PurchaseOrderApproval(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<PurchaseOrderApprovalModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public PurchaseOrderApprovalModel Get(string orgCode, int number, int itemSequence, int sequence, Ungerboeck.Api.Models.Options.Subjects.PurchaseOrderApproval options = null)
    {
      return base.Get(new { orgCode, number, itemSequence, sequence }, options);
    }
    ...
    public PurchaseOrderApprovalModel Add(PurchaseOrderApprovalModel model, Ungerboeck.Api.Models.Options.Subjects.PurchaseOrderApproval options = null)
    {
