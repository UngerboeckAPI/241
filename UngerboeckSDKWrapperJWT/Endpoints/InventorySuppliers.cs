...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class InventorySuppliers : Base<InventorySuppliersModel>
  {
    protected internal InventorySuppliers(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<InventorySuppliersModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public InventorySuppliersModel Get(string orgCode, string inventoryItem, string supplier, Ungerboeck.Api.Models.Options.Subjects.InventorySuppliers options = null)
    {
      return base.Get(new { orgCode, inventoryItem, supplier }, options);
    }
  }
}
