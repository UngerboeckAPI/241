...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class EventsPriceList : Base<EventsPriceListModel>
  {
    protected internal EventsPriceList(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<EventsPriceListModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public EventsPriceListModel Get(string orgCode, string code, int eventID, Ungerboeck.Api.Models.Options.Subjects.EventsPriceList options = null)
    {
      return base.Get(new { orgCode, code, eventID }, options);
    }
  }
}
