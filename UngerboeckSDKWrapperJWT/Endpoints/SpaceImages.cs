...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class SpaceImages : Base<SpaceImagesModel>
  {
    protected internal SpaceImages(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<SpaceImagesModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public SpaceImagesModel Get(string orgCode, int id, Ungerboeck.Api.Models.Options.Subjects.SpaceImages options = null)
    {
    ...
    public SpaceImagesModel Update(SpaceImagesModel model, Ungerboeck.Api.Models.Options.Subjects.SpaceImages options = null)
    {
      return base.Update(new { model.OrgCode, model.Id }, model, options);
    }
    ...
    public SpaceImagesModel Add(SpaceImagesModel model, Ungerboeck.Api.Models.Options.Subjects.SpaceImages options = null)
    {
    ...
    public HttpResponseMessage Delete(string orgCode, int id, Ungerboeck.Api.Models.Options.Subjects.SpaceImages options = null)
    {
