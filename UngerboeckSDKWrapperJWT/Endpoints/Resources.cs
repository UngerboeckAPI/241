...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class Resources : Base<ResourcesModel>
  {
    protected internal Resources(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<ResourcesModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public ResourcesModel Get(string orgCode, int sequence, Ungerboeck.Api.Models.Options.Subjects.Resources options = null)
    {
      return base.Get(new { orgCode, sequence }, options);
    }
    ...
    public ResourcesModel Update(ResourcesModel model, Ungerboeck.Api.Models.Options.Subjects.Resources options = null)
    {
      return base.Update(new { model.Organization, model.Sequence }, model, options);
    }
    ...
    public ResourcesModel Add(ResourcesModel model, Ungerboeck.Api.Models.Options.Subjects.Resources options = null)
    {
    ...
    public HttpResponseMessage Delete(string orgCode, int sequence, Ungerboeck.Api.Models.Options.Subjects.Resources options = null)
    {
      return base.Delete(new { orgCode, sequence }, options);
    }
  }
}
