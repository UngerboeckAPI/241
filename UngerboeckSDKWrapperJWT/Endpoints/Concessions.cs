...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class Concessions : Base<ConcessionsModel>
  {
    protected internal Concessions(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<ConcessionsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public ConcessionsModel Get(string orgCode, int sequenceNumber, Ungerboeck.Api.Models.Options.Subjects.Concessions options = null)
    {
