...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class CoreDimensions : Base<CoreDimensionsModel>
  {
    protected internal CoreDimensions(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<CoreDimensionsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public CoreDimensionsModel Get(string orgCode, string code, Ungerboeck.Api.Models.Options.Subjects.CoreDimensions options = null)
    {
