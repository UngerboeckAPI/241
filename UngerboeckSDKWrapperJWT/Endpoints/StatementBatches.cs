...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class StatementBatches : Base<StatementBatchesModel>
  {
    protected internal StatementBatches(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<StatementBatchesModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public StatementBatchesModel Get(string orgCode, int batch, Ungerboeck.Api.Models.Options.Subjects.StatementBatches options = null)
    {
