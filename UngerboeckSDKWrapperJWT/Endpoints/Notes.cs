...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class Notes : Base<NotesModel>
  {
    protected internal Notes(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<NotesModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public NotesModel Get(string orgCode, string type, string code, decimal sequenceNumber, Ungerboeck.Api.Models.Options.Subjects.Notes options = null)
    {
      return base.Get(new { orgCode, type, code, sequenceNumber }, options);
    }
    ...
    public NotesModel Update(NotesModel model, Ungerboeck.Api.Models.Options.Subjects.Notes options = null)
    {
      return base.Update(new { model.OrganizationCode, model.Type, model.Code, model.SequenceNumber }, model, options);
    }
    ...
    public NotesModel Add(NotesModel model, Ungerboeck.Api.Models.Options.Subjects.Notes options = null)
    {
    ...
    public HttpResponseMessage Delete(string orgCode, string type, string code, decimal sequenceNumber, Ungerboeck.Api.Models.Options.Subjects.Notes options = null)
    {
      return base.Delete(new { orgCode, type, code, sequenceNumber }, options);
    }
  }
}
