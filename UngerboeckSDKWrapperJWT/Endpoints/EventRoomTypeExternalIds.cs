...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class EventRoomTypeExternalIds : Base<EventRoomTypeExternalIdsModel>
  {
    protected internal EventRoomTypeExternalIds(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<EventRoomTypeExternalIdsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public EventRoomTypeExternalIdsModel Get(int id, Ungerboeck.Api.Models.Options.Subjects.EventRoomTypeExternalIds options = null)
    {
    ...
    public EventRoomTypeExternalIdsModel Update(EventRoomTypeExternalIdsModel model, Ungerboeck.Api.Models.Options.Subjects.EventRoomTypeExternalIds options = null)
    {
    ...
    public EventRoomTypeExternalIdsModel Add(EventRoomTypeExternalIdsModel model, Ungerboeck.Api.Models.Options.Subjects.EventRoomTypeExternalIds options = null)
    {
    ...
    public HttpResponseMessage Delete(int id, Ungerboeck.Api.Models.Options.Subjects.EventRoomTypeExternalIds options = null)
    {
