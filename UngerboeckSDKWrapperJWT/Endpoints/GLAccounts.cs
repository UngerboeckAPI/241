...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class GLAccounts : Base<GlAccountsModel>
  {
    protected internal GLAccounts(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<GlAccountsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public GlAccountsModel Get(string orgCode, string gLAccount, string subAccount, Ungerboeck.Api.Models.Options.Subjects.GLAccounts options = null)
    {
      return base.Get(new { orgCode, gLAccount, subAccount }, options);
    }
  }
}
