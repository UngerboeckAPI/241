...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class SpaceFeatures : Base<SpaceFeaturesModel>
  {
    protected internal SpaceFeatures(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<SpaceFeaturesModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public SpaceFeaturesModel Get(string orgCode, string code, Ungerboeck.Api.Models.Options.Subjects.SpaceFeatures options = null)
    {
