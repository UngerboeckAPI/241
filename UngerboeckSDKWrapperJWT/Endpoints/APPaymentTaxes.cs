...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class APPaymentTaxes : Base<APPaymentTaxesModel>
  {
    protected internal APPaymentTaxes(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<APPaymentTaxesModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public APPaymentTaxesModel Get(string orgCode, int sequence, int voucher, int voucherTaxSeq, Ungerboeck.Api.Models.Options.Subjects.APPaymentTaxes options = null)
    {
      return base.Get(new { orgCode, sequence, voucher, voucherTaxSeq }, options);
    }
  }
}
