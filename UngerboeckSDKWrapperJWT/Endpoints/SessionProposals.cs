...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class SessionProposals : Base<SessionProposalsModel>
  {
    protected internal SessionProposals(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<SessionProposalsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public SessionProposalsModel Get(string orgCode, int id, Ungerboeck.Api.Models.Options.Subjects.SessionProposals options = null)
    {
    ...
    public SessionProposalsModel Update(SessionProposalsModel model, Ungerboeck.Api.Models.Options.Subjects.SessionProposals options = null)
    {
      return base.Update(new { model.OrganizationCode, model.ID }, model, options);
    }
    ...
    public SessionProposalsModel Add(SessionProposalsModel model, Ungerboeck.Api.Models.Options.Subjects.SessionProposals options = null)
    {
    ...
    public HttpResponseMessage Delete(string orgCode, int id, Ungerboeck.Api.Models.Options.Subjects.SessionProposals options = null)
    {
      return base.Delete(new { orgCode, id }, options);
    }

    /// <summary>
    /// Custom endpoint.  Assign evaluators to session propoal
    /// </summary>
    /// <param name="options">This contains optional configurations.</param>
    /// <returns>HttpResponseMessage indicating success</returns>
    public HttpResponseMessage AssignEvaluators(string orgCode, int sessionProposalId, SessionProposalsAssignEvaluatorsModel sessionProposalAssignEvaluator, Ungerboeck.Api.Models.Options.Subjects.SessionProposals options = null)
    {
      System.Threading.Tasks.Task<HttpResponseMessage> response = PutAsync<SessionProposalsAssignEvaluatorsModel, HttpResponseMessage>(Client,
        $"SessionProposals/{orgCode}/{sessionProposalId}/AssignEvaluators", sessionProposalAssignEvaluator, options);
