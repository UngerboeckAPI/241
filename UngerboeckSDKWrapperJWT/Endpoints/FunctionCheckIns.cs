...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class FunctionCheckIns : Base<FunctionCheckInsModel>
  {
    protected internal FunctionCheckIns(ApiClient api) : base(api) { }
    ...
    public Ungerboeck.Api.Models.Search.SearchResponse<FunctionCheckInsModel> Search(string searchOData, Search options = null)
    {
    ...
    public FunctionCheckInsModel Get(int sequence, Ungerboeck.Api.Models.Options.Subjects.FunctionCheckIns options = null)
    {
      return base.Get(new { sequence }, options);
    }
    ...
    public FunctionCheckInsModel Update(FunctionCheckInsModel model, Ungerboeck.Api.Models.Options.Subjects.FunctionCheckIns options = null)
    {
      return base.Update(new { model.Sequence }, model, options);
    }
    ...
    public FunctionCheckInsModel Add(FunctionCheckInsModel model, Ungerboeck.Api.Models.Options.Subjects.FunctionCheckIns options = null)
    {
    ...
    public HttpResponseMessage Delete(int sequence, Ungerboeck.Api.Models.Options.Subjects.FunctionCheckIns options = null)
    {
      return base.Delete(new { sequence }, options);
    }
  }
}
