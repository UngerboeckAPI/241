...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class MarketListItems : Base<MarketListItemsModel>
  {
    protected internal MarketListItems(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<MarketListItemsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public MarketListItemsModel Get(string orgCode, string marketList, int sequence, Ungerboeck.Api.Models.Options.Subjects.MarketListItems options = null)
    {
      return base.Get(new { orgCode, marketList, sequence }, options);
    }
  }
}
