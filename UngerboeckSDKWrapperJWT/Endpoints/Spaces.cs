...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class Spaces : Base<SpacesModel>
  {
    protected internal Spaces(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<SpacesModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public SpacesModel Get(string orgCode, string code, Ungerboeck.Api.Models.Options.Subjects.Spaces options = null)
    {
    ...
    public SpacesModel Update(SpacesModel model, Ungerboeck.Api.Models.Options.Subjects.Spaces options = null)
    {
    ...
    public SpacesModel Add(SpacesModel model, Ungerboeck.Api.Models.Options.Subjects.Spaces options = null)
    {
