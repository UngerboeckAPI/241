...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class MembershipCards : Base<MembershipCardsModel>
  {
    protected internal MembershipCards(ApiClient api) : base(api) { }
    ...
    public Ungerboeck.Api.Models.Search.SearchResponse<MembershipCardsModel> Search(string searchOData, Search options = null)
    {
    ...
    public MembershipCardsModel Get(int cardId, Ungerboeck.Api.Models.Options.Subjects.MembershipCards options = null)
    {
      return base.Get(new { cardId }, options);
    }
    ...
    public MembershipCardsModel Update(MembershipCardsModel model, Ungerboeck.Api.Models.Options.Subjects.MembershipCards options = null)
    {
      return base.Update(new { model.CardId }, model, options);
    }
    ...
    public MembershipCardsModel Add(MembershipCardsModel model, Ungerboeck.Api.Models.Options.Subjects.MembershipCards options = null)
    {
    ...
    public HttpResponseMessage Delete(int cardId, Ungerboeck.Api.Models.Options.Subjects.MembershipCards options = null)
    {
      return base.Delete(new { cardId }, options);
    }
  }
}
