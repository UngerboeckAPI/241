...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class EventRoundSessionProposals : Base<EventRoundSessionProposalsModel>
  {
    protected internal EventRoundSessionProposals(ApiClient api) : base(api) { }
    ...
    public Ungerboeck.Api.Models.Search.SearchResponse<EventRoundSessionProposalsModel> Search(string searchOData, Search options = null)
    {
    ...
    public EventRoundSessionProposalsModel Get(int id, Ungerboeck.Api.Models.Options.Subjects.EventRoundSessionProposals options = null)
    {
