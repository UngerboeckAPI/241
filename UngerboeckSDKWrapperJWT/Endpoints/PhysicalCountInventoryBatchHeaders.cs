...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class PhysicalCountInventoryBatchHeaders : Base<PhysicalCountInventoryBatchHeadersModel>
  {
    protected internal PhysicalCountInventoryBatchHeaders(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<PhysicalCountInventoryBatchHeadersModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public PhysicalCountInventoryBatchHeadersModel Get(string orgCode, string batchID, Ungerboeck.Api.Models.Options.Subjects.PhysicalCountInventoryBatchHeaders options = null)
    {
      return base.Get(new { orgCode, batchID }, options);
    }
  }
}
