...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class MeetingFlowPattern : Base<MeetingFlowPatternModel>
  {
    protected internal MeetingFlowPattern(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<MeetingFlowPatternModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public MeetingFlowPatternModel Get(string orgCode, string flowApplicationCode, int meetingTourSequenceNbr, int flowSequenceNumber, Ungerboeck.Api.Models.Options.Subjects.MeetingFlowPattern options = null)
    {
      return base.Get(new { orgCode, flowApplicationCode, meetingTourSequenceNbr, flowSequenceNumber }, options);
    }
  }
}
