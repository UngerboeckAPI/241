...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class Setups : Base<SetupsModel>
  {
    protected internal Setups(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<SetupsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public SetupsModel Get(string orgCode, string code, Ungerboeck.Api.Models.Options.Subjects.Setups options = null)
    {
