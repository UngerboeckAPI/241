...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class ValidationEntries : Base<ValidationEntriesModel>
  {
    protected internal ValidationEntries(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<ValidationEntriesModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public ValidationEntriesModel Get(string orgCode, int validationTableID, int sequenceNumber, Ungerboeck.Api.Models.Options.Subjects.ValidationEntries options = null)
    {
      return base.Get(new { orgCode, validationTableID, sequenceNumber }, options);
    }
    ...
    public ValidationEntriesModel Update(ValidationEntriesModel model, Ungerboeck.Api.Models.Options.Subjects.ValidationEntries options = null)
    {
      return base.Update(new { model.OrganizationCode, model.ValidationTableID, model.SequenceNumber }, model, options);
    }
    ...
    public ValidationEntriesModel Add(ValidationEntriesModel model, Ungerboeck.Api.Models.Options.Subjects.ValidationEntries options = null)
    {
