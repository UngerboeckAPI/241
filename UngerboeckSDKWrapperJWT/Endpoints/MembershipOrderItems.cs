...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class MembershipOrderItems : Base<MembershipOrderItemsModel>
  {
    protected internal MembershipOrderItems(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<MembershipOrderItemsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public MembershipOrderItemsModel Get(string orgCode, int orderNumber, int orderLineNumber, Ungerboeck.Api.Models.Options.Subjects.MembershipOrderItems options = null)
    {
    ...
    public MembershipOrderItemsModel Update(MembershipOrderItemsModel model, Ungerboeck.Api.Models.Options.Subjects.MembershipOrderItems options = null)
    {
    ...
    public MembershipOrderItemsModel Add(MembershipOrderItemsModel model, Ungerboeck.Api.Models.Options.Subjects.MembershipOrderItems options = null)
    {
    ...
    public HttpResponseMessage Delete(string orgCode, int orderNumber, int orderLineNumber, Ungerboeck.Api.Models.Options.Subjects.MembershipOrderItems options = null)
    {
