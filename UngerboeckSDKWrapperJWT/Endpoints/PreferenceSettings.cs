...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class PreferenceSettings : Base<PreferenceSettingsModel>
  {
    protected internal PreferenceSettings(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<PreferenceSettingsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public PreferenceSettingsModel Get(string orgCode, int iD, Ungerboeck.Api.Models.Options.Subjects.PreferenceSettings options = null)
    {
    ...
    public PreferenceSettingsModel Update(PreferenceSettingsModel model, Ungerboeck.Api.Models.Options.Subjects.PreferenceSettings options = null)
    {
      return base.Update(new { model.Organization, model.ID }, model, options);
    }
    ...
    public PreferenceSettingsModel Add(PreferenceSettingsModel model, Ungerboeck.Api.Models.Options.Subjects.PreferenceSettings options = null)
    {
    ...
    public HttpResponseMessage Delete(string orgCode, int iD, Ungerboeck.Api.Models.Options.Subjects.PreferenceSettings options = null)
    {
