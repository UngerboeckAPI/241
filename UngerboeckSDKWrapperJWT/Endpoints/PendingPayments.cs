...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class PendingPayments : Base<PendingPaymentsModel>
  {
    protected internal PendingPayments(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<PendingPaymentsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public PendingPaymentsModel Get(string orgCode, int pendingPaymentID, Ungerboeck.Api.Models.Options.Subjects.PendingPayments options = null)
    {
      return base.Get(new { orgCode, pendingPaymentID }, options);
    }
  }
}
