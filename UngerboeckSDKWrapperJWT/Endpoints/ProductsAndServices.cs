...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class ProductsAndServices : Base<ProductsAndServicesModel>
  {
    protected internal ProductsAndServices(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<ProductsAndServicesModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public ProductsAndServicesModel Get(string orgCode, string code, Ungerboeck.Api.Models.Options.Subjects.ProductsAndServices options = null)
    {
