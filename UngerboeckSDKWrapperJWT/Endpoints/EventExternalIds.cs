...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class EventExternalIds : Base<EventExternalIdsModel>
  {
    protected internal EventExternalIds(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<EventExternalIdsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public EventExternalIdsModel Get(int id, Ungerboeck.Api.Models.Options.Subjects.EventExternalIds options = null)
    {
    ...
    public EventExternalIdsModel Update(EventExternalIdsModel model, Ungerboeck.Api.Models.Options.Subjects.EventExternalIds options = null)
    {
    ...
    public EventExternalIdsModel Add(EventExternalIdsModel model, Ungerboeck.Api.Models.Options.Subjects.EventExternalIds options = null)
    {
    ...
    public HttpResponseMessage Delete(int id, Ungerboeck.Api.Models.Options.Subjects.EventExternalIds options = null)
    {
