...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class Activities : Base<ActivitiesModel>
  {
    protected internal Activities(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<ActivitiesModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public ActivitiesModel Get(string orgCode, string accountCode, int sequenceNumber, Ungerboeck.Api.Models.Options.Subjects.Activities options = null)
    {
    ...
    public ActivitiesModel Update(ActivitiesModel model, Ungerboeck.Api.Models.Options.Subjects.Activities options = null)
    {
    ...
    public ActivitiesModel Add(ActivitiesModel model, Ungerboeck.Api.Models.Options.Subjects.Activities options = null)
    {
    ...
    public HttpResponseMessage Delete(string orgCode, string accountCode, int sequenceNumber, Ungerboeck.Api.Models.Options.Subjects.Activities options = null)
    {
