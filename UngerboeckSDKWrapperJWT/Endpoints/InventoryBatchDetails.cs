...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class InventoryBatchDetails : Base<InventoryBatchDetailsModel>
  {
    protected internal InventoryBatchDetails(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<InventoryBatchDetailsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public InventoryBatchDetailsModel Get(string orgCode, string batch, int sequence, Ungerboeck.Api.Models.Options.Subjects.InventoryBatchDetails options = null)
    {
      return base.Get(new { orgCode, batch, sequence }, options);
    }
  }
}
