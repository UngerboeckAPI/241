...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  public class MembershipAccountItems : Base<MembershipAccountItemsModel>
  {
    ...
    public Ungerboeck.Api.Models.Search.SearchResponse<MembershipAccountItemsModel> Search(string searchOData, Search options = null)
    {
    ...
    public MembershipAccountItemsModel Get(int id, Ungerboeck.Api.Models.Options.Subjects.MembershipAccountItems options = null)
    {
