...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class Invoices : Base<InvoicesModel>
  {
    protected internal Invoices(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<InvoicesModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public InvoicesModel Get(string orgCode, int invoiceNumber, string source, Ungerboeck.Api.Models.Options.Subjects.Invoices options = null)
    {
      return base.Get(new { orgCode, invoiceNumber, source }, options);
    }
    ...
    public InvoicesModel Update(InvoicesModel model, Ungerboeck.Api.Models.Options.Subjects.Invoices options = null)
    {
      return base.Update(new { model.OrganizationCode, model.InvoiceNumber, model.Source }, model, options);
    }
  }
}
