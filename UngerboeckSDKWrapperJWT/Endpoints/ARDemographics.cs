...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class ARDemographics : Base<ARDemographicsModel>
  {
    protected internal ARDemographics(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<ARDemographicsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public ARDemographicsModel Get(string orgCode, string account, Ungerboeck.Api.Models.Options.Subjects.ARDemographics options = null)
    {
      return base.Get(new { orgCode, account }, options);
    }
    ...
    public ARDemographicsModel Update(ARDemographicsModel model, Ungerboeck.Api.Models.Options.Subjects.ARDemographics options = null)
    {
      return base.Update(new { model.Organization, model.Account }, model, options);
    }
    ...
    public ARDemographicsModel Add(ARDemographicsModel model, Ungerboeck.Api.Models.Options.Subjects.ARDemographics options = null)
    {
    ...
    public HttpResponseMessage Delete(string orgCode, string account, Ungerboeck.Api.Models.Options.Subjects.ARDemographics options = null)
    {
      return base.Delete(new { orgCode, account }, options);
    }
  }
}
