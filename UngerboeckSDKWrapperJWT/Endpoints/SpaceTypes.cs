...
{
  public class SpaceTypes : Base<SpaceTypesModel>
  {
    protected internal SpaceTypes(ApiClient api) : base(api) { }
    ...
    public Ungerboeck.Api.Models.Search.SearchResponse<SpaceTypesModel> Search(string searchOData, Search options = null)
    {
    ...
    public SpaceTypesModel Get(string code, Ungerboeck.Api.Models.Options.Subjects.SpaceTypes options = null)
    {
