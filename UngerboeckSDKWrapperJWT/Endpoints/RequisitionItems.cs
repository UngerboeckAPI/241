...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class RequisitionItems : Base<RequisitionItemsModel>
  {
    protected internal RequisitionItems(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<RequisitionItemsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public RequisitionItemsModel Get(string orgCode, int number, int sequence, Ungerboeck.Api.Models.Options.Subjects.RequisitionItems options = null)
    {
      return base.Get(new { orgCode, number, sequence }, options);
    }
  }
}
