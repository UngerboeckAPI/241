...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class RequisitionApproval : Base<RequisitionApprovalModel>
  {
    protected internal RequisitionApproval(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<RequisitionApprovalModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public RequisitionApprovalModel Get(string orgCode, int number, int line, int sequence, Ungerboeck.Api.Models.Options.Subjects.RequisitionApproval options = null)
    {
      return base.Get(new { orgCode, number, line, sequence }, options);
    }
  }
}
