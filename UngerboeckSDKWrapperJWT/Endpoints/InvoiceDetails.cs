...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class InvoiceDetails : Base<InvoiceDetailsModel>
  {
    protected internal InvoiceDetails(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<InvoiceDetailsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public InvoiceDetailsModel Get(string orgCode, int invoiceNumber, int orderNumber, int orderLine, Ungerboeck.Api.Models.Options.Subjects.InvoiceDetails options = null)
    {
      return base.Get(new { orgCode, invoiceNumber, orderNumber, orderLine }, options);
    }
  }
}
