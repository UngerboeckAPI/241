...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class GLSpaceMinor : Base<GLSpaceMinorModel>
  {
    protected internal GLSpaceMinor(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<GLSpaceMinorModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public GLSpaceMinorModel Get(string orgCode, string code, Ungerboeck.Api.Models.Options.Subjects.GLSpaceMinor options = null)
    {
    ...
    public GLSpaceMinorModel Update(GLSpaceMinorModel model, Ungerboeck.Api.Models.Options.Subjects.GLSpaceMinor options = null)
    {
    ...
    public GLSpaceMinorModel Add(GLSpaceMinorModel model, Ungerboeck.Api.Models.Options.Subjects.GLSpaceMinor options = null)
    {
