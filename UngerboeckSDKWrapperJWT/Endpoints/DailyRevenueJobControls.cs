...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class DailyRevenueJobControls : Base<DailyRevenueJobControlsModel>
  {
    protected internal DailyRevenueJobControls(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<DailyRevenueJobControlsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public DailyRevenueJobControlsModel Get(string orgcode, int sequence, Ungerboeck.Api.Models.Options.Subjects.DailyRevenueJobControls options = null)
    {
