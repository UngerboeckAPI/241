...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class EventProductsAndServices : Base<EventProductsAndServicesModel>
  {
    protected internal EventProductsAndServices(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<EventProductsAndServicesModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public EventProductsAndServicesModel Get(string orgCode, int sequenceNumber, Ungerboeck.Api.Models.Options.Subjects.EventProductsAndServices options = null)
    {
    ...
    public EventProductsAndServicesModel Update(EventProductsAndServicesModel model, Ungerboeck.Api.Models.Options.Subjects.EventProductsAndServices options = null)
    {
    ...
    public EventProductsAndServicesModel Add(EventProductsAndServicesModel model, Ungerboeck.Api.Models.Options.Subjects.EventProductsAndServices options = null)
    {
