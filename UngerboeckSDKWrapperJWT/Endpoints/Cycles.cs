...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class Cycles : Base<CyclesModel>
  {
    protected internal Cycles(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<CyclesModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public CyclesModel Get(string orgCode, string code, Ungerboeck.Api.Models.Options.Subjects.Cycles options = null)
    {
