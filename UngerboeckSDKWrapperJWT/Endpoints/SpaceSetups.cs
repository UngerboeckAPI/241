...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class SpaceSetups : Base<SpaceSetupsModel>
  {
    protected internal SpaceSetups(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<SpaceSetupsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public SpaceSetupsModel Get(string orgCode, string space, string code, Ungerboeck.Api.Models.Options.Subjects.SpaceSetups options = null)
    {
      return base.Get(new { orgCode, space, code }, options);
    }
    ...
    public SpaceSetupsModel Update(SpaceSetupsModel model, Ungerboeck.Api.Models.Options.Subjects.SpaceSetups options = null)
    {
      return base.Update(new { model.OrganizationCode, model.Space, model.Code }, model, options);
    }
    ...
    public SpaceSetupsModel Add(SpaceSetupsModel model, Ungerboeck.Api.Models.Options.Subjects.SpaceSetups options = null)
    {
    ...
    public HttpResponseMessage Delete(string orgCode, string space, string code, Ungerboeck.Api.Models.Options.Subjects.SpaceSetups options = null)
    {
      return base.Delete(new { orgCode, space, code }, options);
    }
  }
}
