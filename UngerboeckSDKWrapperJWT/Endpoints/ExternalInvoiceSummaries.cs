...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class ExternalInvoiceSummaries : Base<ExternalInvoiceSummariesModel>
  {
    protected internal ExternalInvoiceSummaries(ApiClient api) : base(api) { }
    ...
    public Ungerboeck.Api.Models.Search.SearchResponse<ExternalInvoiceSummariesModel> Search(string searchOData, Search options = null)
    {
    ...
    public ExternalInvoiceSummariesModel Get(int summaryID, Ungerboeck.Api.Models.Options.Subjects.ExternalInvoiceSummaries options = null)
    {
      return base.Get(new { summaryID }, options);
    }
  }
}
