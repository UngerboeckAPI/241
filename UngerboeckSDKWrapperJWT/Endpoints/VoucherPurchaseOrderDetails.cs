...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class VoucherPurchaseOrderDetails : Base<VoucherPurchaseOrderDetailsModel>
  {
    protected internal VoucherPurchaseOrderDetails(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<VoucherPurchaseOrderDetailsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public VoucherPurchaseOrderDetailsModel Get(string orgCode, int voucher, int pONumber, int sequence, Ungerboeck.Api.Models.Options.Subjects.VoucherPurchaseOrderDetails options = null)
    {
      return base.Get(new { orgCode, voucher, pONumber, sequence }, options);
    }
  }
}
