...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class GLAccountAnalysisCodes : Base<GLAccountAnalysisCodesModel>
  {
    protected internal GLAccountAnalysisCodes(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<GLAccountAnalysisCodesModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public GLAccountAnalysisCodesModel Get(string orgCode, string code, Ungerboeck.Api.Models.Options.Subjects.GLAccountAnalysisCodes options = null)
    {
