...
{
  public class EventBlockExternalIds : Base<EventBlockExternalIdsModel>
  {
    protected internal EventBlockExternalIds(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<EventBlockExternalIdsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public EventBlockExternalIdsModel Get(int id, Ungerboeck.Api.Models.Options.Subjects.EventBlockExternalIds options = null)
    {
    ...
    public EventBlockExternalIdsModel Update(EventBlockExternalIdsModel model, Ungerboeck.Api.Models.Options.Subjects.EventBlockExternalIds options = null)
    {
    ...
    public EventBlockExternalIdsModel Add(EventBlockExternalIdsModel model, Ungerboeck.Api.Models.Options.Subjects.EventBlockExternalIds options = null)
    {
    ...
    public HttpResponseMessage Delete(int id, Ungerboeck.Api.Models.Options.Subjects.EventBlockExternalIds options = null)
    {
