...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class Departments : Base<DepartmentsModel>
  {
    protected internal Departments(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<DepartmentsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public DepartmentsModel Get(string orgCode, string code, Ungerboeck.Api.Models.Options.Subjects.Departments options = null)
    {
