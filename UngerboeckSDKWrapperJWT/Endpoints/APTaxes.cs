...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class APTaxes : Base<APTaxesModel>
  {
    protected internal APTaxes(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<APTaxesModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public APTaxesModel Get(string orgCode, string supplierAccountCode, int sequenceNumber, Ungerboeck.Api.Models.Options.Subjects.APTaxes options = null)
    {
      return base.Get(new { orgCode, supplierAccountCode, sequenceNumber }, options);
    }
  }
}
