...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class Bulletins : Base<BulletinsModel>
  {
    protected internal Bulletins(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<BulletinsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public BulletinsModel Get(string orgCode, string bulletinApplication, int meeting, int bulletin, Ungerboeck.Api.Models.Options.Subjects.Bulletins options = null)
    {
      return base.Get(new { orgCode, bulletinApplication, meeting, bulletin }, options);
    }
  }
}
