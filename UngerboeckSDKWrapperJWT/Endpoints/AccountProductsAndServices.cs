...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class AccountProductsAndServices : Base<AccountsProductsAndServicesModel>
  {
    protected internal AccountProductsAndServices(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<AccountsProductsAndServicesModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public AccountsProductsAndServicesModel Get(string orgCode, string accountCode, string productServiceCode, Ungerboeck.Api.Models.Options.Subjects.AccountProductsAndServices options = null)
    {
      return base.Get(new { orgCode, accountCode, productServiceCode }, options);
    }
    ...
    public AccountsProductsAndServicesModel Add(AccountsProductsAndServicesModel model, Ungerboeck.Api.Models.Options.Subjects.AccountProductsAndServices options = null)
    {
    ...
    public HttpResponseMessage Delete(string orgCode, string accountCode, string productServiceCode, Ungerboeck.Api.Models.Options.Subjects.AccountProductsAndServices options = null)
    {
      return base.Delete(new { orgCode, accountCode, productServiceCode }, options);
    }
  }
}
