...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class BankAccounts : Base<BankAccountsModel>
  {
    protected internal BankAccounts(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<BankAccountsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public BankAccountsModel Get(string orgCode, string code, Ungerboeck.Api.Models.Options.Subjects.BankAccounts options = null)
    {
