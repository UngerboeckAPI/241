...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class EventOpportunityGuestRoomFlow : Base<EventOpportunityGuestRoomFlowModel>
  {
    protected internal EventOpportunityGuestRoomFlow(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<EventOpportunityGuestRoomFlowModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    /// </summary>
    /// <param name="id">Id of event opportunity guest room flow.</param>
    /// <param name="options">This contains optional configurations.</param>
    /// <returns>A single model for this subject.</returns>
    public EventOpportunityGuestRoomFlowModel Get(int id, Ungerboeck.Api.Models.Options.Subjects.EventOpportunityGuestRoomFlow options = null)
    {
    ...
    public EventOpportunityGuestRoomFlowModel Update(EventOpportunityGuestRoomFlowModel model, Ungerboeck.Api.Models.Options.Subjects.EventOpportunityGuestRoomFlow options = null)
    {
