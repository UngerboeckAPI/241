...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class GLSpaceMajor : Base<GLSpaceMajorModel>
  {
    protected internal GLSpaceMajor(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<GLSpaceMajorModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public GLSpaceMajorModel Get(string orgCode, string code, Ungerboeck.Api.Models.Options.Subjects.GLSpaceMajor options = null)
    {
    ...
    public GLSpaceMajorModel Update(GLSpaceMajorModel model, Ungerboeck.Api.Models.Options.Subjects.GLSpaceMajor options = null)
    {
    ...
    public GLSpaceMajorModel Add(GLSpaceMajorModel model, Ungerboeck.Api.Models.Options.Subjects.GLSpaceMajor options = null)
    {
