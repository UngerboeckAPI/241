...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class EventServices : Base<EventServicesModel>
  {
    protected internal EventServices(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<EventServicesModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public EventServicesModel Get(string orgCode, int eventID, int sequenceNumber, Ungerboeck.Api.Models.Options.Subjects.EventServices options = null)
    {
      return base.Get(new { orgCode, eventID, sequenceNumber }, options);
    }
    ...
    public EventServicesModel Update(EventServicesModel model, Ungerboeck.Api.Models.Options.Subjects.EventServices options = null)
    {
      return base.Update(new { model.OrganizationCode, model.EventID, model.SequenceNumber }, model, options);
    }
    ...
    public EventServicesModel Add(EventServicesModel model, Ungerboeck.Api.Models.Options.Subjects.EventServices options = null)
    {
    ...
    public HttpResponseMessage Delete(string orgCode, int eventID, int sequenceNumber, Ungerboeck.Api.Models.Options.Subjects.EventServices options = null)
    {
      return base.Delete(new { orgCode, eventID, sequenceNumber }, options);
    }
  }
}
