...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class EventStatuses : Base<EventStatusesModel>
  {
    protected internal EventStatuses(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<EventStatusesModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public EventStatusesModel Get(string orgCode, string code, Ungerboeck.Api.Models.Options.Subjects.EventStatuses options = null)
    {
