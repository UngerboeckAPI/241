...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class AccountTypes : Base<AccountTypesModel>
  {
    protected internal AccountTypes(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<AccountTypesModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public AccountTypesModel Get(string orgCode, string code, Ungerboeck.Api.Models.Options.Subjects.AccountTypes options = null)
    {
