...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class PriceList : Base<PriceListModel>
  {
    protected internal PriceList(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<PriceListModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public PriceListModel Get(string orgCode, string code, Ungerboeck.Api.Models.Options.Subjects.PriceList options = null)
    {
    ...
    public PriceListModel Update(PriceListModel model, Ungerboeck.Api.Models.Options.Subjects.PriceList options = null)
    {
    ...
    public PriceListModel Add(PriceListModel model, Ungerboeck.Api.Models.Options.Subjects.PriceList options = null)
    {
    ...
    public HttpResponseMessage Delete(string orgCode, string code, Ungerboeck.Api.Models.Options.Subjects.PriceList options = null)
    {
