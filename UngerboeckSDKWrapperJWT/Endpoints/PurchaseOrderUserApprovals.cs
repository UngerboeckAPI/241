...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class PurchaseOrderUserApprovals : Base<PurchaseOrderUserApprovalsModel>
  {
    protected internal PurchaseOrderUserApprovals(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<PurchaseOrderUserApprovalsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public PurchaseOrderUserApprovalsModel Get(string orgCode, int sequence, Ungerboeck.Api.Models.Options.Subjects.PurchaseOrderUserApprovals options = null)
    {
