...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class FiscalYears : Base<FiscalYearsModel>
  {
    protected internal FiscalYears(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<FiscalYearsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public FiscalYearsModel Get(string orgCode, int year, Ungerboeck.Api.Models.Options.Subjects.FiscalYears options = null)
    {
      return base.Get(new { orgCode, year }, options);
    }
  }
}
