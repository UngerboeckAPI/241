...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class PaymentPlans : Base<PaymentPlansModel>
  {
    protected internal PaymentPlans(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<PaymentPlansModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public PaymentPlansModel Get(string orgCode, int paymentPlanID, Ungerboeck.Api.Models.Options.Subjects.PaymentPlans options = null)
    {
      return base.Get(new { orgCode, paymentPlanID }, options);
    }
  }
}
