...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class PaymentPlanHeaders : Base<PaymentPlanHeadersModel>
  {
    protected internal PaymentPlanHeaders(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<PaymentPlanHeadersModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public PaymentPlanHeadersModel Get(string orgCode, int payPlanID, int paymentNumber, Ungerboeck.Api.Models.Options.Subjects.PaymentPlanHeaders options = null)
    {
      return base.Get(new { orgCode, payPlanID, paymentNumber }, options);
    }
  }
}
