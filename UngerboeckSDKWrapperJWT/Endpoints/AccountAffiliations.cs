...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class AccountAffiliations : Base<AccountAffiliationsModel>
  {
    protected internal AccountAffiliations(ApiClient api) : base(api) { }
    ...
    public new SearchResponse<AccountAffiliationsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public AccountAffiliationsModel Get(string orgCode, string accountCode, string affiliationCode, Ungerboeck.Api.Models.Options.Subjects.AccountAffiliations options = null)
    {
      return base.Get(new { orgCode, accountCode, affiliationCode }, options);
    }
    ...
    public AccountAffiliationsModel Add(AccountAffiliationsModel model, Ungerboeck.Api.Models.Options.Subjects.AccountAffiliations options = null)
    {
    ...
    public HttpResponseMessage Delete(string orgCode, string accountCode, string affiliationCode, Ungerboeck.Api.Models.Options.Subjects.AccountAffiliations options = null)
    {
      return base.Delete(new { orgCode, accountCode, affiliationCode }, options);
    }
  }
}
