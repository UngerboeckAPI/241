...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class Jobs : Base<JobsModel>
  {
    protected internal Jobs(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<JobsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public JobsModel Get(string orgCode, int jobID, Ungerboeck.Api.Models.Options.Subjects.Jobs options = null)
    {
      return base.Get(new { orgCode, jobID }, options);
    }
    ...
    public JobsModel Update(JobsModel model, Ungerboeck.Api.Models.Options.Subjects.Jobs options = null)
    {
      return base.Update(new { model.Organization, model.JobID }, model, options);
    }
    ...
    public JobsModel Add(JobsModel model, Ungerboeck.Api.Models.Options.Subjects.Jobs options = null)
    {
