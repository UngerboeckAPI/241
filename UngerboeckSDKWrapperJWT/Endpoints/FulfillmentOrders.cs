...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class FulfillmentOrders : Base<FulfillmentOrdersModel>
  {
    protected internal FulfillmentOrders(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<FulfillmentOrdersModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public FulfillmentOrdersModel Get(string orgCode, int orderNumber, Ungerboeck.Api.Models.Options.Subjects.FulfillmentOrders options = null)
    {
    ...
    public FulfillmentOrdersModel Update(FulfillmentOrdersModel model, Ungerboeck.Api.Models.Options.Subjects.FulfillmentOrders options = null)
    {
    ...
    public FulfillmentOrdersModel Add(FulfillmentOrdersModel model, Ungerboeck.Api.Models.Options.Subjects.FulfillmentOrders options = null)
    {
