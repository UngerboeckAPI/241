...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class TransactionMethods : Base<TransactionMethodsModel>
  {
    protected internal TransactionMethods(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<TransactionMethodsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public TransactionMethodsModel Get(string orgCode, string code, Ungerboeck.Api.Models.Options.Subjects.TransactionMethods options = null)
    {
