...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class ExternalSystemSubjects : Base<ExternalSystemSubjectsModel>
  {
    protected internal ExternalSystemSubjects(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<ExternalSystemSubjectsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public ExternalSystemSubjectsModel Get(int id, Ungerboeck.Api.Models.Options.Subjects.ExternalSystemSubjects options = null)
    {
    ...
    public ExternalSystemSubjectsModel Update(ExternalSystemSubjectsModel model, Ungerboeck.Api.Models.Options.Subjects.ExternalSystemSubjects options = null)
    {
    ...
    public ExternalSystemSubjectsModel Add(ExternalSystemSubjectsModel model, Ungerboeck.Api.Models.Options.Subjects.ExternalSystemSubjects options = null)
    {
    ...
    public HttpResponseMessage Delete(int id, Ungerboeck.Api.Models.Options.Subjects.ExternalSystemSubjects options = null)
    {
