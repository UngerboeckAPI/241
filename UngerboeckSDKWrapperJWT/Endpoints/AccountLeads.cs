...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class AccountLeads : Base<AccountLeadsModel>
  {
    protected internal AccountLeads(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<AccountLeadsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public AccountLeadsModel Get(string orgCode, int leadId, Ungerboeck.Api.Models.Options.Subjects.AccountLeads options = null)
    {
      return base.Get(new { orgCode, leadId }, options);
    }
    ...
    public AccountLeadsModel Update(AccountLeadsModel model, Ungerboeck.Api.Models.Options.Subjects.AccountLeads options = null)
    {
      return base.Update(new { model.OrganizationCode, model.LeadID }, model, options);
    }
    ...
    public AccountLeadsModel Add(AccountLeadsModel model, Ungerboeck.Api.Models.Options.Subjects.AccountLeads options = null)
    {
    ...
    public HttpResponseMessage Delete(string orgCode, int leadId, Ungerboeck.Api.Models.Options.Subjects.AccountLeads options = null)
    {
      return base.Delete(new { orgCode, leadId }, options);
    }
  }
}
