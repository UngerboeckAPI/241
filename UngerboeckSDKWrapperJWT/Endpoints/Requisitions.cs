...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class Requisitions : Base<RequisitionsModel>
  {
    protected internal Requisitions(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<RequisitionsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public RequisitionsModel Get(string orgCode, int number, Ungerboeck.Api.Models.Options.Subjects.Requisitions options = null)
    {
