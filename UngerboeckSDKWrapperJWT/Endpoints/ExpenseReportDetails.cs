...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class ExpenseReportDetails : Base<ExpenseReportDetailsModel>
  {
    protected internal ExpenseReportDetails(ApiClient api) : base(api) { }
    ...
    public Ungerboeck.Api.Models.Search.SearchResponse<ExpenseReportDetailsModel> Search(string searchOData, Search options = null)
    {
    ...
    public ExpenseReportDetailsModel Get(int sequence, Ungerboeck.Api.Models.Options.Subjects.ExpenseReportDetails options = null)
    {
