...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class Affiliations : Base<AffiliationsModel>
  {
    protected internal Affiliations(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<AffiliationsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public AffiliationsModel Get(string orgCode, string affiliationCode, Ungerboeck.Api.Models.Options.Subjects.Affiliations options = null)
    {
      return base.Get(new { orgCode, affiliationCode }, options);
    }
  }
}
