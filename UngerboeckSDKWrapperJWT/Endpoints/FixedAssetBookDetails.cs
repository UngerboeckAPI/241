...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class FixedAssetBookDetails : Base<FixedAssetBookDetailsModel>
  {
    protected internal FixedAssetBookDetails(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<FixedAssetBookDetailsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public FixedAssetBookDetailsModel Get(string orgCode, string asset, string book, Ungerboeck.Api.Models.Options.Subjects.FixedAssetBookDetails options = null)
    {
      return base.Get(new { orgCode, asset, book }, options);
    }
  }
}
