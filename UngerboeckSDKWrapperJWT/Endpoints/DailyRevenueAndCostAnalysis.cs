...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class DailyRevenueAndCostAnalysis : Base<DailyRevenueAndCostAnalysisModel>
  {
    protected internal DailyRevenueAndCostAnalysis(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<DailyRevenueAndCostAnalysisModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public DailyRevenueAndCostAnalysisModel Get(string orgCode, int revenueSequence, Ungerboeck.Api.Models.Options.Subjects.DailyRevenueAndCostAnalysis options = null)
    {
      return base.Get(new { orgCode, revenueSequence }, options);
    }
  }
}
