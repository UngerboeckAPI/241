...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class MeetingNotes : Base<MeetingNotesModel>
  {
    protected internal MeetingNotes(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<MeetingNotesModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public MeetingNotesModel Get(string orgCode, string bulletinApplication, int meeting, int bulletinSeqNbr, int sequenceNbr, Ungerboeck.Api.Models.Options.Subjects.MeetingNotes options = null)
    {
      return base.Get(new { orgCode, bulletinApplication, meeting, bulletinSeqNbr, sequenceNbr }, options);
    }
  }
}
