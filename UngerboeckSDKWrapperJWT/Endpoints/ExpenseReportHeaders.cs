...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class ExpenseReportHeaders : Base<ExpenseReportHeadersModel>
  {
    protected internal ExpenseReportHeaders(ApiClient api) : base(api) { }
    ...
    public Ungerboeck.Api.Models.Search.SearchResponse<ExpenseReportHeadersModel> Search(string searchOData, Search options = null)
    {
    ...
    public ExpenseReportHeadersModel Get(int iD, Ungerboeck.Api.Models.Options.Subjects.ExpenseReportHeaders options = null)
    {
