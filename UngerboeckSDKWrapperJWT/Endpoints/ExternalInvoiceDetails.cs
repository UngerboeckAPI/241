...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class ExternalInvoiceDetails : Base<ExternalInvoiceDetailsModel>
  {
    protected internal ExternalInvoiceDetails(ApiClient api) : base(api) { }
    ...
    public Ungerboeck.Api.Models.Search.SearchResponse<ExternalInvoiceDetailsModel> Search(string searchOData, Search options = null)
    {
    ...
    public ExternalInvoiceDetailsModel Get(int detailIDExt, Ungerboeck.Api.Models.Options.Subjects.ExternalInvoiceDetails options = null)
    {
      return base.Get(new { detailIDExt }, options);
    }
  }
}
