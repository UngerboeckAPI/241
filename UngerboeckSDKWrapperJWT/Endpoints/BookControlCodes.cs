...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class BookControlCodes : Base<BookControlCodesModel>
  {
    protected internal BookControlCodes(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<BookControlCodesModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public BookControlCodesModel Get(string orgCode, string code, Ungerboeck.Api.Models.Options.Subjects.BookControlCodes options = null)
    {
    ...
    public BookControlCodesModel Update(BookControlCodesModel model, Ungerboeck.Api.Models.Options.Subjects.BookControlCodes options = null)
    {
      return base.Update(new { model.OrgCode, model.Code }, model, options);
    }
    ...
    public BookControlCodesModel Add(BookControlCodesModel model, Ungerboeck.Api.Models.Options.Subjects.BookControlCodes options = null)
    {
