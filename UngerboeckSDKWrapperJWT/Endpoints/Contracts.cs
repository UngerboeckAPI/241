...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class Contracts : Base<ContractsModel>
  {
    protected internal Contracts(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<ContractsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public ContractsModel Get(string orgCode, int sequence, Ungerboeck.Api.Models.Options.Subjects.Contracts options = null)
    {
