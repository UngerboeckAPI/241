...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class RegistrationOrderItems : Base<RegistrationOrderItemsModel>
  {
    protected internal RegistrationOrderItems(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<RegistrationOrderItemsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public RegistrationOrderItemsModel Get(string orgCode, int orderNumber, int orderLineNumber, Ungerboeck.Api.Models.Options.Subjects.RegistrationOrderItems options = null)
    {
    ...
    public RegistrationOrderItemsModel Update(RegistrationOrderItemsModel model, Ungerboeck.Api.Models.Options.Subjects.RegistrationOrderItems options = null)
    {
      return base.Update(new { model.OrganizationCode, model.OrderNumber, model.OrderLineNumber }, model, options);
    }
    ...
    public RegistrationOrderItemsModel Add(RegistrationOrderItemsModel model, Ungerboeck.Api.Models.Options.Subjects.RegistrationOrderItems options = null)
    {
    ...
    public HttpResponseMessage Delete(string orgCode, int orderNumber, int orderLineNumber, Ungerboeck.Api.Models.Options.Subjects.RegistrationOrderItems options = null)
    {
      return base.Delete(new { orgCode, orderNumber, orderLineNumber }, options);
    }
  }
}
