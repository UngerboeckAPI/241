...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class ResourceTaxRates : Base<ResourceTaxRatesModel>
  {
    protected internal ResourceTaxRates(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<ResourceTaxRatesModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public ResourceTaxRatesModel Get(string orgCode, int sequence, Ungerboeck.Api.Models.Options.Subjects.ResourceTaxRates options = null)
    {
