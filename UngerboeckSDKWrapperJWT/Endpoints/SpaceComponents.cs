...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class SpaceComponents : Base<SpaceComponentsModel>
  {
    protected internal SpaceComponents(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<SpaceComponentsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public SpaceComponentsModel Get(string orgCode, string space, string component, Ungerboeck.Api.Models.Options.Subjects.SpaceComponents options = null)
    {
      return base.Get(new { orgCode, space, component }, options);
    }
  }
}
