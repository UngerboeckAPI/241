...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class ExhibitorProductVideos : Base<ExhibitorProductVideosModel>
  {
    protected internal ExhibitorProductVideos(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<ExhibitorProductVideosModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public ExhibitorProductVideosModel Get(int id, Ungerboeck.Api.Models.Options.Subjects.ExhibitorProductVideos options = null)
    {
    ...
    public ExhibitorProductVideosModel Update(ExhibitorProductVideosModel model, Ungerboeck.Api.Models.Options.Subjects.ExhibitorProductVideos options = null)
    {
    ...
    public ExhibitorProductVideosModel Add(ExhibitorProductVideosModel model, Ungerboeck.Api.Models.Options.Subjects.ExhibitorProductVideos options = null)
    {
