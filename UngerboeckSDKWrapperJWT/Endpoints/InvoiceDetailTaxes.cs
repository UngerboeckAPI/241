...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class InvoiceDetailTaxes : Base<InvoiceDetailTaxesModel>
  {
    protected internal InvoiceDetailTaxes(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<InvoiceDetailTaxesModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public InvoiceDetailTaxesModel Get(string orgCode, int invoiceNumber, int orderNumber, int orderLineNumber, int sequenceNumber, Ungerboeck.Api.Models.Options.Subjects.InvoiceDetailTaxes options = null)
    {
      return base.Get(new { orgCode, invoiceNumber, orderNumber, orderLineNumber, sequenceNumber }, options);
    }
  }
}
