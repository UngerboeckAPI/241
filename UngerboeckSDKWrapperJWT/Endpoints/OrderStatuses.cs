...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class OrderStatuses : Base<OrderStatusesModel>
  {
    protected internal OrderStatuses(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<OrderStatusesModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public OrderStatusesModel Get(string orgCode, string code, Ungerboeck.Api.Models.Options.Subjects.OrderStatuses options = null)
    {
