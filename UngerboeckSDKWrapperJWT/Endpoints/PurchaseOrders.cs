...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  public class PurchaseOrders : Base<PurchaseOrdersModel>
  {
    ...
    /// <summary>
    /// Use this endpoint to receive purchase order items belonging to a single purchase order.
    /// </summary>
    /// <param name="model">This should contain a filled model of this subject.  Note that any null model properties will be ignored for the save.</param>
    /// <param name="options">This contains optional configurations.</param>
    /// <returns>An updated, single model for this subject.</returns>
    public PurchaseOrdersModel Receive(PurchaseOrderReceiveRequestModel model, Ungerboeck.Api.Models.Options.Subjects.PurchaseOrders options = null)
    {
      System.Threading.Tasks.Task<PurchaseOrdersModel> response = PutAsync<PurchaseOrderReceiveRequestModel, PurchaseOrdersModel>(Client, $"/PurchaseOrders/Receive", model, options);
