...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class Distributions : Base<DistributionsModel>
  {
    protected internal Distributions(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<DistributionsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public DistributionsModel Get(string orgCode, string bulletinApplication, int meeting, int bulletin, int distributionEntrySeqNbr, Ungerboeck.Api.Models.Options.Subjects.Distributions options = null)
    {
      return base.Get(new { orgCode, bulletinApplication, meeting, bulletin, distributionEntrySeqNbr }, options);
    }
  }
}
