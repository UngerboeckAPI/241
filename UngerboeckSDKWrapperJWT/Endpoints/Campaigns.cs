...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class Campaigns : Base<CampaignsModel>
  {
    protected internal Campaigns(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<CampaignsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public CampaignsModel Get(string orgCode, string iD, string designation, Ungerboeck.Api.Models.Options.Subjects.Campaigns options = null)
    {
      return base.Get(new { orgCode, iD, designation }, options);
    }
    ...
    public CampaignsModel Update(CampaignsModel model, Ungerboeck.Api.Models.Options.Subjects.Campaigns options = null)
    {
      return base.Update(new { model.OrganizationCode, model.ID, model.Designation }, model, options);
    }
    ...
    public CampaignsModel Add(CampaignsModel model, Ungerboeck.Api.Models.Options.Subjects.Campaigns options = null)
    {
