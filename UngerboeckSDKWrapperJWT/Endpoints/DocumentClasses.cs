...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class DocumentClasses : Base<DocumentClassesModel>
  {
    protected internal DocumentClasses(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<DocumentClassesModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public DocumentClassesModel Get(string orgCode, string @class, Ungerboeck.Api.Models.Options.Subjects.DocumentClasses options = null)
    {
      return base.Get(new { orgCode, @class }, options);
    }
  }
}
