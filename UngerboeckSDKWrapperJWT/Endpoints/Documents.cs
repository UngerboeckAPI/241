...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class Documents : Base<DocumentsModel>
  {
    protected internal Documents(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<DocumentsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public DocumentsModel Get(string orgCode, string type, int sequenceNumber, Ungerboeck.Api.Models.Options.Subjects.Documents options = null)
    {
      return base.Get(new { orgCode, type, sequenceNumber }, options);
    }
    ...
    public DocumentsModel Update(DocumentsModel model, Ungerboeck.Api.Models.Options.Subjects.Documents options = null)
    {
      return base.Update(new { model.Organization, model.Type, model.SequenceNumber }, model, options);
    }
    ...
    public DocumentsModel Add(DocumentsModel model, Ungerboeck.Api.Models.Options.Subjects.Documents options = null)
    {
    ...
    public HttpResponseMessage Delete(string orgCode, string type, int sequenceNumber, Ungerboeck.Api.Models.Options.Subjects.Documents options = null)
    {
      return base.Delete(new { orgCode, type, sequenceNumber }, options);
    }

    /// <summary>
    /// Custom endpoint.  Get a document's file bytes.
    /// </summary>
    /// <param name="options">This contains optional configurations.</param>
    /// <returns>Byte array</returns>
    public string Download(string orgCode, string type, int sequenceNumber, Ungerboeck.Api.Models.Options.Subjects.Documents options = null)
    {
      Task<HttpResponseMessage> documentBytesTask =
          base.GetAsync<HttpResponseMessage>(Client, $"Documents/{orgCode}/{type}/{sequenceNumber}/Download", options);
      var task = GetResponseContentAsString(documentBytesTask);
      return task.Result;
    }    
  }
}
