...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class ExhibitorSocialMedia : Base<ExhibitorSocialMediaModel>
  {
    protected internal ExhibitorSocialMedia(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<ExhibitorSocialMediaModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public ExhibitorSocialMediaModel Get(int id, Ungerboeck.Api.Models.Options.Subjects.ExhibitorSocialMedia options = null)
    {
    ...
    public ExhibitorSocialMediaModel Update(ExhibitorSocialMediaModel model, Ungerboeck.Api.Models.Options.Subjects.ExhibitorSocialMedia options = null)
    {
    ...
    public ExhibitorSocialMediaModel Add(ExhibitorSocialMediaModel model, Ungerboeck.Api.Models.Options.Subjects.ExhibitorSocialMedia options = null)
    {
