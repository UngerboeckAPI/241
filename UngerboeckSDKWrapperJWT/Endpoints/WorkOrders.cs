...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class WorkOrders : Base<WorkOrdersModel>
  {
    protected internal WorkOrders(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<WorkOrdersModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public WorkOrdersModel Get(string orgCode, int order, string department, Ungerboeck.Api.Models.Options.Subjects.WorkOrders options = null)
    {
      return base.Get(new { orgCode, order, department }, options);
    }
  }
}
