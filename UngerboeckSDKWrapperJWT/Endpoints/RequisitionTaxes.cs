...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class RequisitionTaxes : Base<RequisitionTaxesModel>
  {
    protected internal RequisitionTaxes(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<RequisitionTaxesModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public RequisitionTaxesModel Get(string orgCode, int number, int line, int sequence, Ungerboeck.Api.Models.Options.Subjects.RequisitionTaxes options = null)
    {
